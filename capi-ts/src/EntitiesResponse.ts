...
export interface IEntitiesResponse {
  status: string;
  total: number;
  results: Array<com_gu_contententity_thrift.IEntity>;
}
export interface IEntitiesResponseArgs {
  status: string;
  total: number;
  results: Array<com_gu_contententity_thrift.IEntityArgs>;
}
export const EntitiesResponseCodec: thrift.IStructCodec<
  IEntitiesResponseArgs,
  IEntitiesResponse
> = {
  ...
  decode(input: thrift.TProtocol): IEntitiesResponse {
    ...
    if (
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read EntitiesResponse from input'
      );
    }
  },
};
export class EntitiesResponse extends thrift.StructLike
  implements IEntitiesResponse {
  public status: string;
  public total: number;
  public results: Array<com_gu_contententity_thrift.IEntity>;
  ...
  constructor(args: IEntitiesResponseArgs) {
    ...
    if (args.results != null) {
      const value_8: Array<com_gu_contententity_thrift.IEntity> = new Array<
        com_gu_contententity_thrift.IEntity
      >();
      args.results.forEach(
        (value_9: com_gu_contententity_thrift.IEntityArgs): void => {
