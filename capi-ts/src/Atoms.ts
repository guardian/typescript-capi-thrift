...
export const AtomsCodec: thrift.IStructCodec<IAtomsArgs, IAtoms> = {
    encode(args: IAtomsArgs, output: thrift.TProtocol): void {
        ...
        if (obj.quizzes != null) {
            ...
            obj.quizzes.forEach((value_1: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.viewpoints != null) {
            ...
            obj.viewpoints.forEach((value_2: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.media != null) {
            ...
            obj.media.forEach((value_3: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.explainers != null) {
            ...
            obj.explainers.forEach((value_4: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.cta != null) {
            ...
            obj.cta.forEach((value_5: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.interactives != null) {
            ...
            obj.interactives.forEach((value_6: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.reviews != null) {
            ...
            obj.reviews.forEach((value_7: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.recipes != null) {
            ...
            obj.recipes.forEach((value_8: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.storyquestions != null) {
            ...
            obj.storyquestions.forEach((value_9: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.qandas != null) {
            ...
            obj.qandas.forEach((value_10: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.guides != null) {
            ...
            obj.guides.forEach((value_11: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.profiles != null) {
            ...
            obj.profiles.forEach((value_12: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.timelines != null) {
            ...
            obj.timelines.forEach((value_13: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.commonsdivisions != null) {
            ...
            obj.commonsdivisions.forEach((value_14: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.charts != null) {
            ...
            obj.charts.forEach((value_15: com_gu_contentatom_thrift.IAtomArgs): void => {
        ...
        if (obj.audios != null) {
            ...
            obj.audios.forEach((value_16: com_gu_contentatom_thrift.IAtomArgs): void => {
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.LIST) {
                        const value_17: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_18: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(input);
                ...
                case 2:
                    if (fieldType === thrift.TType.LIST) {
                        const value_19: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_20: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(input);
                ...
                case 3:
                    if (fieldType === thrift.TType.LIST) {
                        const value_21: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                        const metadata_3: thrift.IThriftList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_22: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(input);
                ...
                case 4:
                    if (fieldType === thrift.TType.LIST) {
                        const value_23: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                        const metadata_4: thrift.IThriftList = input.readListBegin();
                        const size_4: number = metadata_4.size;
                        for (let i_4: number = 0; i_4 < size_4; i_4++) {
                            const value_24: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(input);
                ...
                case 5:
                    if (fieldType === thrift.TType.LIST) {
                        const value_25: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                        const metadata_5: thrift.IThriftList = input.readListBegin();
                        const size_5: number = metadata_5.size;
                        for (let i_5: number = 0; i_5 < size_5; i_5++) {
                            const value_26: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(input);
                ...
                case 6:
                    if (fieldType === thrift.TType.LIST) {
                        const value_27: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                        const metadata_6: thrift.IThriftList = input.readListBegin();
                        const size_6: number = metadata_6.size;
                        for (let i_6: number = 0; i_6 < size_6; i_6++) {
                            const value_28: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(input);
                ...
                case 7:
                    if (fieldType === thrift.TType.LIST) {
                        const value_29: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                        ...
                        for (let i_7: number = 0; i_7 < size_7; i_7++) {
                            const value_30: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(input);
                ...
                case 8:
                    if (fieldType === thrift.TType.LIST) {
                        const value_31: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                        ...
                        for (let i_8: number = 0; i_8 < size_8; i_8++) {
                            const value_32: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(input);
                ...
                case 9:
                    if (fieldType === thrift.TType.LIST) {
                        const value_33: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                        ...
                        for (let i_9: number = 0; i_9 < size_9; i_9++) {
                            const value_34: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(input);
                ...
                case 10:
                    if (fieldType === thrift.TType.LIST) {
                        const value_35: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                        ...
                        for (let i_10: number = 0; i_10 < size_10; i_10++) {
                            const value_36: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(input);
                ...
                case 11:
                    if (fieldType === thrift.TType.LIST) {
                        const value_37: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                ...
                case 12:
                    if (fieldType === thrift.TType.LIST) {
                        const value_39: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                ...
                case 13:
                    if (fieldType === thrift.TType.LIST) {
                        const value_41: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                ...
                case 14:
                    if (fieldType === thrift.TType.LIST) {
                        const value_43: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                ...
                case 15:
                    if (fieldType === thrift.TType.LIST) {
                        const value_45: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                ...
                case 16:
                    if (fieldType === thrift.TType.LIST) {
                        const value_47: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
...
export class Atoms extends thrift.StructLike implements IAtoms {
    ...
    constructor(args: IAtomsArgs = {}) {
        ...
        if (args.quizzes != null) {
            const value_49: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.quizzes.forEach((value_65: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_66: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_65);
                value_49.push(value_66);
            });
            this.quizzes = value_49;
        }
        if (args.viewpoints != null) {
            const value_50: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.viewpoints.forEach((value_67: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_68: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_67);
                value_50.push(value_68);
            });
            this.viewpoints = value_50;
        }
        if (args.media != null) {
            const value_51: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.media.forEach((value_69: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_70: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_69);
                value_51.push(value_70);
            });
            this.media = value_51;
        }
        if (args.explainers != null) {
            const value_52: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.explainers.forEach((value_71: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_72: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_71);
                value_52.push(value_72);
            });
            this.explainers = value_52;
        }
        if (args.cta != null) {
            const value_53: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.cta.forEach((value_73: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_74: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_73);
                value_53.push(value_74);
            });
            this.cta = value_53;
        }
        if (args.interactives != null) {
            const value_54: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.interactives.forEach((value_75: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_76: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_75);
                value_54.push(value_76);
            });
            this.interactives = value_54;
        }
        if (args.reviews != null) {
            const value_55: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.reviews.forEach((value_77: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_78: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_77);
                value_55.push(value_78);
            });
            this.reviews = value_55;
        }
        if (args.recipes != null) {
            const value_56: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.recipes.forEach((value_79: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_80: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_79);
                value_56.push(value_80);
            });
            this.recipes = value_56;
        }
        if (args.storyquestions != null) {
            const value_57: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.storyquestions.forEach((value_81: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_82: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_81);
                value_57.push(value_82);
            });
            this.storyquestions = value_57;
        }
        if (args.qandas != null) {
            const value_58: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.qandas.forEach((value_83: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_84: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_83);
                value_58.push(value_84);
            });
            this.qandas = value_58;
        }
        if (args.guides != null) {
            const value_59: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.guides.forEach((value_85: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_86: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_85);
                value_59.push(value_86);
            });
            this.guides = value_59;
        }
        if (args.profiles != null) {
            const value_60: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.profiles.forEach((value_87: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_88: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_87);
                value_60.push(value_88);
            });
            this.profiles = value_60;
        }
        if (args.timelines != null) {
            const value_61: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.timelines.forEach((value_89: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_90: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_89);
                value_61.push(value_90);
            });
            this.timelines = value_61;
        }
        if (args.commonsdivisions != null) {
            const value_62: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.commonsdivisions.forEach((value_91: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_92: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_91);
                value_62.push(value_92);
            });
            this.commonsdivisions = value_62;
        }
        if (args.charts != null) {
            const value_63: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.charts.forEach((value_93: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_94: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_93);
                value_63.push(value_94);
            });
            this.charts = value_63;
        }
        if (args.audios != null) {
            const value_64: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.audios.forEach((value_95: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_96: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_95);
