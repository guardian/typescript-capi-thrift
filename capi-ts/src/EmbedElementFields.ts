...
export const EmbedElementFieldsCodec: thrift.IStructCodec<
  IEmbedElementFieldsArgs,
  IEmbedElementFields
> = {
...
export class EmbedElementFields extends thrift.StructLike
  implements IEmbedElementFields {
  public html?: string;
