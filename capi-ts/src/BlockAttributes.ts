...
export interface IBlockAttributes {
  ...
  title?: string;
  pinned?: boolean;
  membershipPlaceholder?: __NAMESPACE__.IMembershipPlaceholder;
}
export interface IBlockAttributesArgs {
  ...
  title?: string;
  pinned?: boolean;
  membershipPlaceholder?: __NAMESPACE__.IMembershipPlaceholderArgs;
}
export const BlockAttributesCodec: thrift.IStructCodec<
  IBlockAttributesArgs,
  IBlockAttributes
> = {
  encode(args: IBlockAttributesArgs, output: thrift.TProtocol): void {
    ...
    if (obj.membershipPlaceholder != null) {
      ...
      __NAMESPACE__.MembershipPlaceholderCodec.encode(
        obj.membershipPlaceholder,
        output
      );
      output.writeFieldEnd();
    }
      ...
      switch (fieldId) {
        ...
        case 5:
          if (fieldType === thrift.TType.STRUCT) {
            const value_5: __NAMESPACE__.IMembershipPlaceholder = __NAMESPACE__.MembershipPlaceholderCodec.decode(
              input
            );
...
export class BlockAttributes extends thrift.StructLike
  implements IBlockAttributes {
  public keyEvent?: boolean;
  public summary?: boolean;
  public title?: string;
  public pinned?: boolean;
  public membershipPlaceholder?: __NAMESPACE__.IMembershipPlaceholder;
  ...
  constructor(args: IBlockAttributesArgs = {}) {
    ...
    if (args.membershipPlaceholder != null) {
      const value_10: __NAMESPACE__.IMembershipPlaceholder = new __NAMESPACE__.MembershipPlaceholder(
        args.membershipPlaceholder
      );
