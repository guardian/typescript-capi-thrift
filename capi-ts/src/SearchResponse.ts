...
export const SearchResponseCodec: thrift.IStructCodec<
  ISearchResponseArgs,
  ISearchResponse
> = {
  ...
  decode(input: thrift.TProtocol): ISearchResponse {
        ...
        case 9:
          if (fieldType === thrift.TType.LIST) {
            ...
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_11: __NAMESPACE__.IContent = __NAMESPACE__.ContentCodec.decode(
                input
              );
    ...
    if (
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read SearchResponse from input'
      );
    }
  },
};
export class SearchResponse extends thrift.StructLike
  ...
  constructor(args: ISearchResponseArgs) {
    ...
    if (args.results != null) {
      const value_20: Array<__NAMESPACE__.IContent> = new Array<
        __NAMESPACE__.IContent
      >();
      args.results.forEach(
        (value_21: __NAMESPACE__.IContentArgs): void => {
          const value_22: __NAMESPACE__.IContent = new __NAMESPACE__.Content(
            value_21
          );
