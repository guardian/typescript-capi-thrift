...
export const BlocksCodec: thrift.IStructCodec<IBlocksArgs, IBlocks> = {
  encode(args: IBlocksArgs, output: thrift.TProtocol): void {
    ...
    if (obj.body != null) {
      ...
      obj.body.forEach(
        (value_1: __NAMESPACE__.IBlockArgs): void => {
    ...
    if (obj.requestedBodyBlocks != null) {
      ...
      output.writeMapBegin(
        thrift.TType.STRING,
        thrift.TType.LIST,
        obj.requestedBodyBlocks.size
      );
      obj.requestedBodyBlocks.forEach(
        (value_2: Array<__NAMESPACE__.IBlockArgs>, key_1: string): void => {
          output.writeString(key_1);
          output.writeListBegin(thrift.TType.STRUCT, value_2.length);
          value_2.forEach(
            (value_3: __NAMESPACE__.IBlockArgs): void => {
      ...
      switch (fieldId) {
        case 1:
          if (fieldType === thrift.TType.STRUCT) {
            const value_4: __NAMESPACE__.IBlock = __NAMESPACE__.BlockCodec.decode(
              input
            );
            _args.main = value_4;
          } else {
        ...
        case 2:
          if (fieldType === thrift.TType.LIST) {
            const value_5: Array<__NAMESPACE__.IBlock> = new Array<
              __NAMESPACE__.IBlock
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_6: __NAMESPACE__.IBlock = __NAMESPACE__.BlockCodec.decode(
                input
              );
        ...
        case 4:
          if (fieldType === thrift.TType.MAP) {
            const value_8: Map<string, Array<__NAMESPACE__.IBlock>> = new Map<
              string,
              Array<__NAMESPACE__.IBlock>
            >();
            const metadata_2: thrift.IThriftMap = input.readMapBegin();
            const size_2: number = metadata_2.size;
            for (let i_2: number = 0; i_2 < size_2; i_2++) {
              const key_2: string = input.readString();
              const value_9: Array<__NAMESPACE__.IBlock> = new Array<
                __NAMESPACE__.IBlock
              >();
              const metadata_3: thrift.IThriftList = input.readListBegin();
              const size_3: number = metadata_3.size;
              for (let i_3: number = 0; i_3 < size_3; i_3++) {
                const value_10: __NAMESPACE__.IBlock = __NAMESPACE__.BlockCodec.decode(
                  input
                );
...
export class Blocks extends thrift.StructLike implements IBlocks {
  ...
  constructor(args: IBlocksArgs = {}) {
    ...
    if (args.body != null) {
      const value_12: Array<__NAMESPACE__.IBlock> = new Array<
        __NAMESPACE__.IBlock
      >();
      args.body.forEach(
        (value_15: __NAMESPACE__.IBlockArgs): void => {
          const value_16: __NAMESPACE__.IBlock = new __NAMESPACE__.Block(
            value_15
          );
    ...
    if (args.requestedBodyBlocks != null) {
      const value_14: Map<string, Array<__NAMESPACE__.IBlock>> = new Map<
        string,
        Array<__NAMESPACE__.IBlock>
      >();
      args.requestedBodyBlocks.forEach(
        (value_17: Array<__NAMESPACE__.IBlockArgs>, key_3: string): void => {
          const value_18: Array<__NAMESPACE__.IBlock> = new Array<
            __NAMESPACE__.IBlock
          >();
          value_17.forEach(
            (value_19: __NAMESPACE__.IBlockArgs): void => {
              const value_20: __NAMESPACE__.IBlock = new __NAMESPACE__.Block(
                value_19
              );
