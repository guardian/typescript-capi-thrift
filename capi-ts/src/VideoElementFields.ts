...
export const VideoElementFieldsCodec: thrift.IStructCodec<
  IVideoElementFieldsArgs,
  IVideoElementFields
> = {
...
export class VideoElementFields extends thrift.StructLike
  implements IVideoElementFields {
  public url?: string;
