...
export const VineElementFieldsCodec: thrift.IStructCodec<
  IVineElementFieldsArgs,
  IVineElementFields
> = {
  ...
  decode(input: thrift.TProtocol): IVineElementFields {
    ...
    if (
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read VineElementFields from input'
      );
    }
  },
};
export class VineElementFields extends thrift.StructLike
  implements IVineElementFields {
