...
export const PullquoteElementFieldsCodec: thrift.IStructCodec<
  IPullquoteElementFieldsArgs,
  IPullquoteElementFields
> = {
...
export class PullquoteElementFields extends thrift.StructLike
  implements IPullquoteElementFields {
  public html?: string;
  ...
  public static read(input: thrift.TProtocol): PullquoteElementFields {
    return new PullquoteElementFields(
      PullquoteElementFieldsCodec.decode(input)
    );
  }
  public static write(
    args: IPullquoteElementFieldsArgs,
