...
export interface IDebug {
  lastSeenByPorterAt?: __NAMESPACE__.ICapiDateTime;
  revisionSeenByPorter?: thrift.Int64;
  contentSource?: string;
  originatingSystem?: string;
}
export interface IDebugArgs {
  lastSeenByPorterAt?: __NAMESPACE__.ICapiDateTimeArgs;
  ...
  encode(args: IDebugArgs, output: thrift.TProtocol): void {
    const obj = {
      ...
      revisionSeenByPorter:
        typeof args.revisionSeenByPorter === 'number'
          ? new thrift.Int64(args.revisionSeenByPorter)
          : typeof args.revisionSeenByPorter === 'string'
          ? thrift.Int64.fromDecimalString(args.revisionSeenByPorter)
          : args.revisionSeenByPorter,
    ...
    if (obj.lastSeenByPorterAt != null) {
      ...
      __NAMESPACE__.CapiDateTimeCodec.encode(obj.lastSeenByPorterAt, output);
      output.writeFieldEnd();
    }
    if (obj.revisionSeenByPorter != null) {
      output.writeFieldBegin('revisionSeenByPorter', thrift.TType.I64, 2);
      output.writeI64(
        typeof obj.revisionSeenByPorter === 'number'
          ? new thrift.Int64(obj.revisionSeenByPorter)
          : typeof obj.revisionSeenByPorter === 'string'
          ? thrift.Int64.fromDecimalString(obj.revisionSeenByPorter)
          : obj.revisionSeenByPorter
      );
      output.writeFieldEnd();
    }
      ...
      switch (fieldId) {
        case 1:
          if (fieldType === thrift.TType.STRUCT) {
            const value_1: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(
              input
            );
...
export class Debug extends thrift.StructLike implements IDebug {
  public lastSeenByPorterAt?: __NAMESPACE__.ICapiDateTime;
  ...
  constructor(args: IDebugArgs = {}) {
    ...
    if (args.lastSeenByPorterAt != null) {
      const value_5: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.lastSeenByPorterAt
      );
