...
export const MembershipElementFieldsCodec: thrift.IStructCodec<
  IMembershipElementFieldsArgs,
  IMembershipElementFields
> = {
...
export class MembershipElementFields extends thrift.StructLike
  implements IMembershipElementFields {
  ...
  public static read(input: thrift.TProtocol): MembershipElementFields {
    return new MembershipElementFields(
      MembershipElementFieldsCodec.decode(input)
    );
  }
  public static write(
    args: IMembershipElementFieldsArgs,
