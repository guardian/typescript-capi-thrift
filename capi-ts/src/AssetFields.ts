...
export interface IAssetFields {
  ...
  apiUrl?: string;
  dateCreated?: __NAMESPACE__.ICapiDateTime;
  youtubeUrl?: string;
  ...
  identifier?: string;
  price?: string;
  start?: __NAMESPACE__.ICapiDateTime;
  end?: __NAMESPACE__.ICapiDateTime;
...
export interface IAssetFieldsArgs {
  ...
  authorGuardianProfileUrl?: string;
  apiUrl?: string;
  dateCreated?: __NAMESPACE__.ICapiDateTimeArgs;
  youtubeUrl?: string;
  youtubeSource?: string;
  youtubeTitle?: string;
  youtubeDescription?: string;
  ...
  identifier?: string;
  price?: string;
  start?: __NAMESPACE__.ICapiDateTimeArgs;
  end?: __NAMESPACE__.ICapiDateTimeArgs;
  safeEmbedCode?: boolean;
}
export const AssetFieldsCodec: thrift.IStructCodec<
  IAssetFieldsArgs,
  IAssetFields
> = {
  encode(args: IAssetFieldsArgs, output: thrift.TProtocol): void {
    const obj = {
      ...
      sizeInBytes:
        typeof args.sizeInBytes === 'number'
          ? new thrift.Int64(args.sizeInBytes)
          : typeof args.sizeInBytes === 'string'
          ? thrift.Int64.fromDecimalString(args.sizeInBytes)
          : args.sizeInBytes,
    ...
    if (obj.sizeInBytes != null) {
      ...
      output.writeI64(
        typeof obj.sizeInBytes === 'number'
          ? new thrift.Int64(obj.sizeInBytes)
          : typeof obj.sizeInBytes === 'string'
          ? thrift.Int64.fromDecimalString(obj.sizeInBytes)
          : obj.sizeInBytes
      );
      output.writeFieldEnd();
    }
    ...
    if (obj.dateCreated != null) {
      ...
      __NAMESPACE__.CapiDateTimeCodec.encode(obj.dateCreated, output);
      output.writeFieldEnd();
    }
    ...
    if (obj.start != null) {
      ...
      __NAMESPACE__.CapiDateTimeCodec.encode(obj.start, output);
      output.writeFieldEnd();
    }
    if (obj.end != null) {
      output.writeFieldBegin('end', thrift.TType.STRUCT, 67);
      __NAMESPACE__.CapiDateTimeCodec.encode(obj.end, output);
      output.writeFieldEnd();
    }
      ...
      switch (fieldId) {
        ...
        case 55:
          if (fieldType === thrift.TType.STRUCT) {
            const value_55: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(
              input
            );
        ...
        case 66:
          if (fieldType === thrift.TType.STRUCT) {
            const value_66: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(
              input
            );
        ...
        case 67:
          if (fieldType === thrift.TType.STRUCT) {
            const value_67: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(
              input
            );
            _args.end = value_67;
          } else {
...
export class AssetFields extends thrift.StructLike implements IAssetFields {
  ...
  public dateCreated?: __NAMESPACE__.ICapiDateTime;
  ...
  public price?: string;
  public start?: __NAMESPACE__.ICapiDateTime;
  public end?: __NAMESPACE__.ICapiDateTime;
  ...
  constructor(args: IAssetFieldsArgs = {}) {
    ...
    if (args.dateCreated != null) {
      const value_123: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.dateCreated
      );
    ...
    if (args.start != null) {
      const value_134: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.start
      );
      this.start = value_134;
    }
    if (args.end != null) {
      const value_135: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.end
      );
      this.end = value_135;
    }
