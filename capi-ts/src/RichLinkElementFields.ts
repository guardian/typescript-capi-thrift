...
export interface IRichLinkElementFields {
  ...
  linkPrefix?: string;
  role?: string;
  sponsorship?: __NAMESPACE__.ISponsorship;
}
export interface IRichLinkElementFieldsArgs {
  ...
  linkPrefix?: string;
  role?: string;
  sponsorship?: __NAMESPACE__.ISponsorshipArgs;
}
export const RichLinkElementFieldsCodec: thrift.IStructCodec<
  IRichLinkElementFieldsArgs,
  IRichLinkElementFields
> = {
  encode(args: IRichLinkElementFieldsArgs, output: thrift.TProtocol): void {
    ...
    if (obj.sponsorship != null) {
      ...
      __NAMESPACE__.SponsorshipCodec.encode(obj.sponsorship, output);
      output.writeFieldEnd();
    }
      ...
      switch (fieldId) {
        ...
        case 6:
          if (fieldType === thrift.TType.STRUCT) {
            const value_6: __NAMESPACE__.ISponsorship = __NAMESPACE__.SponsorshipCodec.decode(
              input
            );
...
export class RichLinkElementFields extends thrift.StructLike
  implements IRichLinkElementFields {
  public url?: string;
  public originalUrl?: string;
  public linkText?: string;
  public linkPrefix?: string;
  public role?: string;
  public sponsorship?: __NAMESPACE__.ISponsorship;
  ...
  constructor(args: IRichLinkElementFieldsArgs = {}) {
    ...
    if (args.sponsorship != null) {
      const value_12: __NAMESPACE__.ISponsorship = new __NAMESPACE__.Sponsorship(
        args.sponsorship
      );
  ...
  public static write(
    args: IRichLinkElementFieldsArgs,
