...
import * as RemovedContent from "./RemovedContent";
export interface IRemovedContentResponse {
    ...
    resultsWithLastModified?: Array<RemovedContent.IRemovedContent>;
}
export interface IRemovedContentResponseArgs {
    ...
    orderBy: string;
    results: Array<string>;
    resultsWithLastModified?: Array<RemovedContent.IRemovedContentArgs>;
}
export const RemovedContentResponseCodec: thrift.IStructCodec<IRemovedContentResponseArgs, IRemovedContentResponse> = {
    encode(args: IRemovedContentResponseArgs, output: thrift.TProtocol): void {
        ...
        if (obj.resultsWithLastModified != null) {
            ...
            output.writeListBegin(thrift.TType.STRUCT, obj.resultsWithLastModified.length);
            obj.resultsWithLastModified.forEach((value_2: RemovedContent.IRemovedContentArgs): void => {
                RemovedContent.RemovedContentCodec.encode(value_2, output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    decode(input: thrift.TProtocol): IRemovedContentResponse {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 10:
                    if (fieldType === thrift.TType.LIST) {
                        const value_13: Array<RemovedContent.IRemovedContent> = new Array<RemovedContent.IRemovedContent>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_14: RemovedContent.IRemovedContent = RemovedContent.RemovedContentCodec.decode(input);
        ...
        if (_args.status !== undefined && _args.userTier !== undefined && _args.total !== undefined && _args.startIndex !== undefined && _args.pageSize !== undefined && _args.currentPage !== undefined && _args.pages !== undefined && _args.orderBy !== undefined && _args.results !== undefined) {
            ...
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Unable to read RemovedContentResponse from input");
        }
    }
};
export class RemovedContentResponse extends thrift.StructLike implements IRemovedContentResponse {
    ...
    public resultsWithLastModified?: Array<RemovedContent.IRemovedContent>;
    ...
    constructor(args: IRemovedContentResponseArgs) {
        ...
        if (args.results != null) {
            ...
            args.results.forEach((value_25: string): void => {
        ...
        if (args.resultsWithLastModified != null) {
            const value_24: Array<RemovedContent.IRemovedContent> = new Array<RemovedContent.IRemovedContent>();
            args.resultsWithLastModified.forEach((value_27: RemovedContent.IRemovedContentArgs): void => {
                const value_28: RemovedContent.IRemovedContent = new RemovedContent.RemovedContent(value_27);
    ...
    public static read(input: thrift.TProtocol): RemovedContentResponse {
        return new RemovedContentResponse(RemovedContentResponseCodec.decode(input));
    }
    public static write(args: IRemovedContentResponseArgs, output: thrift.TProtocol): void {
