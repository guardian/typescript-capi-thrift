...
export const SponsorshipCodec: thrift.IStructCodec<
  ISponsorshipArgs,
  ISponsorship
> = {
  encode(args: ISponsorshipArgs, output: thrift.TProtocol): void {
    ...
    if (obj.sponsorshipType != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[sponsorshipType] is unset!'
      );
    }
    if (obj.sponsorName != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[sponsorName] is unset!'
      );
    }
    if (obj.sponsorLogo != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[sponsorLogo] is unset!'
      );
    }
    if (obj.sponsorLink != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[sponsorLink] is unset!'
      );
    }
    ...
    if (obj.sponsorLogoDimensions != null) {
      ...
      __NAMESPACE__.SponsorshipLogoDimensionsCodec.encode(
        obj.sponsorLogoDimensions,
        output
      );
      output.writeFieldEnd();
    }
    ...
    if (obj.highContrastSponsorLogoDimensions != null) {
      ...
      __NAMESPACE__.SponsorshipLogoDimensionsCodec.encode(
        obj.highContrastSponsorLogoDimensions,
        output
      );
      output.writeFieldEnd();
    }
  ...
  decode(input: thrift.TProtocol): ISponsorship {
      ...
      switch (fieldId) {
        ...
        case 5:
          if (fieldType === thrift.TType.STRUCT) {
            const value_5: __NAMESPACE__.ISponsorshipTargeting = __NAMESPACE__.SponsorshipTargetingCodec.decode(
              input
            );
        ...
        case 7:
          if (fieldType === thrift.TType.STRUCT) {
            const value_7: __NAMESPACE__.ISponsorshipLogoDimensions = __NAMESPACE__.SponsorshipLogoDimensionsCodec.decode(
              input
            );
        ...
        case 9:
          if (fieldType === thrift.TType.STRUCT) {
            const value_9: __NAMESPACE__.ISponsorshipLogoDimensions = __NAMESPACE__.SponsorshipLogoDimensionsCodec.decode(
              input
            );
    ...
    input.readStructEnd();
    if (
      _args.sponsorshipType !== undefined &&
      _args.sponsorName !== undefined &&
      _args.sponsorLogo !== undefined &&
      _args.sponsorLink !== undefined
    ) {
      return {
        ...
        highContrastSponsorLogoDimensions:
          _args.highContrastSponsorLogoDimensions,
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Sponsorship from input'
      );
    }
  },
};
export class Sponsorship extends thrift.StructLike implements ISponsorship {
  ...
  constructor(args: ISponsorshipArgs) {
    ...
    if (args.targeting != null) {
      const value_16: __NAMESPACE__.ISponsorshipTargeting = new __NAMESPACE__.SponsorshipTargeting(
        args.targeting
      );
    ...
    if (args.sponsorLogoDimensions != null) {
      const value_18: __NAMESPACE__.ISponsorshipLogoDimensions = new __NAMESPACE__.SponsorshipLogoDimensions(
        args.sponsorLogoDimensions
      );
    ...
    if (args.highContrastSponsorLogoDimensions != null) {
      const value_20: __NAMESPACE__.ISponsorshipLogoDimensions = new __NAMESPACE__.SponsorshipLogoDimensions(
        args.highContrastSponsorLogoDimensions
      );
      this.highContrastSponsorLogoDimensions = value_20;
    }
    if (args.validFrom != null) {
      const value_21: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.validFrom
      );
      this.validFrom = value_21;
    }
    if (args.validTo != null) {
      const value_22: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.validTo
      );
