...
export const PillarsResponseCodec: thrift.IStructCodec<
  IPillarsResponseArgs,
  IPillarsResponse
> = {
  encode(args: IPillarsResponseArgs, output: thrift.TProtocol): void {
    ...
    if (obj.results != null) {
      ...
      obj.results.forEach(
        (value_1: __NAMESPACE__.IPillarArgs): void => {
  ...
  decode(input: thrift.TProtocol): IPillarsResponse {
      ...
      switch (fieldId) {
        ...
        case 3:
          if (fieldType === thrift.TType.LIST) {
            const value_4: Array<__NAMESPACE__.IPillar> = new Array<
              __NAMESPACE__.IPillar
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_5: __NAMESPACE__.IPillar = __NAMESPACE__.PillarCodec.decode(
                input
              );
    ...
    if (
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read PillarsResponse from input'
      );
    }
  },
};
export class PillarsResponse extends thrift.StructLike
  implements IPillarsResponse {
  ...
  constructor(args: IPillarsResponseArgs) {
    ...
    if (args.results != null) {
      const value_8: Array<__NAMESPACE__.IPillar> = new Array<
        __NAMESPACE__.IPillar
      >();
      args.results.forEach(
        (value_9: __NAMESPACE__.IPillarArgs): void => {
          const value_10: __NAMESPACE__.IPillar = new __NAMESPACE__.Pillar(
            value_9
          );
