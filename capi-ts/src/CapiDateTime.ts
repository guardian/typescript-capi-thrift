...
export const CapiDateTimeCodec: thrift.IStructCodec<
  ICapiDateTimeArgs,
  ICapiDateTime
> = {
  encode(args: ICapiDateTimeArgs, output: thrift.TProtocol): void {
    const obj = {
      dateTime:
        typeof args.dateTime === 'number'
          ? new thrift.Int64(args.dateTime)
          : typeof args.dateTime === 'string'
          ? thrift.Int64.fromDecimalString(args.dateTime)
          : args.dateTime,
    ...
    if (obj.dateTime != null) {
      ...
      output.writeI64(
        typeof obj.dateTime === 'number'
          ? new thrift.Int64(obj.dateTime)
          : typeof obj.dateTime === 'string'
          ? thrift.Int64.fromDecimalString(obj.dateTime)
          : obj.dateTime
      );
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[dateTime] is unset!'
      );
    }
    if (obj.iso8601 != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[iso8601] is unset!'
      );
    }
  ...
  decode(input: thrift.TProtocol): ICapiDateTime {
    ...
    if (_args.dateTime !== undefined && _args.iso8601 !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read CapiDateTime from input'
      );
    }
  },
};
