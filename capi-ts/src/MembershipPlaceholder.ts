...
export const MembershipPlaceholderCodec: thrift.IStructCodec<
  IMembershipPlaceholderArgs,
  IMembershipPlaceholder
> = {
...
export class MembershipPlaceholder extends thrift.StructLike
  implements IMembershipPlaceholder {
  ...
  public static write(
    args: IMembershipPlaceholderArgs,
