...
export const AtomUsageResponseCodec: thrift.IStructCodec<
  IAtomUsageResponseArgs,
  IAtomUsageResponse
> = {
  ...
  decode(input: thrift.TProtocol): IAtomUsageResponse {
    ...
    if (
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read AtomUsageResponse from input'
      );
    }
  },
};
export class AtomUsageResponse extends thrift.StructLike
  implements IAtomUsageResponse {
