...
export const PackageArticleCodec: thrift.IStructCodec<
  IPackageArticleArgs,
  IPackageArticle
> = {
  encode(args: IPackageArticleArgs, output: thrift.TProtocol): void {
    ...
    if (obj.metadata != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[metadata] is unset!'
      );
    }
    if (obj.content != null) {
  ...
  decode(input: thrift.TProtocol): IPackageArticle {
      ...
      switch (fieldId) {
        case 1:
          if (fieldType === thrift.TType.STRUCT) {
            const value_1: com_gu_storypackage_model_v1.IArticle = com_gu_storypackage_model_v1.ArticleCodec.decode(
              input
            );
        ...
        case 2:
          if (fieldType === thrift.TType.STRUCT) {
            const value_2: __NAMESPACE__.IContent = __NAMESPACE__.ContentCodec.decode(
              input
            );
    ...
    if (_args.metadata !== undefined && _args.content !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read PackageArticle from input'
      );
    }
  },
};
export class PackageArticle extends thrift.StructLike
  implements IPackageArticle {
  ...
  constructor(args: IPackageArticleArgs) {
    ...
    if (args.metadata != null) {
      const value_3: com_gu_storypackage_model_v1.IArticle = new com_gu_storypackage_model_v1.Article(
        args.metadata
      );
    ...
    if (args.content != null) {
      const value_4: __NAMESPACE__.IContent = new __NAMESPACE__.Content(
        args.content
      );
