...
export const SponsorshipLogoDimensionsCodec: thrift.IStructCodec<
  ISponsorshipLogoDimensionsArgs,
  ISponsorshipLogoDimensions
> = {
  encode(args: ISponsorshipLogoDimensionsArgs, output: thrift.TProtocol): void {
    ...
    if (obj.height != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[height] is unset!'
      );
    }
  ...
  decode(input: thrift.TProtocol): ISponsorshipLogoDimensions {
    ...
    if (_args.width !== undefined && _args.height !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read SponsorshipLogoDimensions from input'
      );
    }
  },
};
export class SponsorshipLogoDimensions extends thrift.StructLike
  implements ISponsorshipLogoDimensions {
  public width: number;
  ...
  public static read(input: thrift.TProtocol): SponsorshipLogoDimensions {
    return new SponsorshipLogoDimensions(
      SponsorshipLogoDimensionsCodec.decode(input)
    );
  }
  public static write(
    args: ISponsorshipLogoDimensionsArgs,
