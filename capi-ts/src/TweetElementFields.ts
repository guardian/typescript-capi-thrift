...
export const TweetElementFieldsCodec: thrift.IStructCodec<
  ITweetElementFieldsArgs,
  ITweetElementFields
> = {
...
export class TweetElementFields extends thrift.StructLike
  implements ITweetElementFields {
