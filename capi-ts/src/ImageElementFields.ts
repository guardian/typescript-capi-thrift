...
export const ImageElementFieldsCodec: thrift.IStructCodec<
  IImageElementFieldsArgs,
  IImageElementFields
> = {
...
export class ImageElementFields extends thrift.StructLike
  implements IImageElementFields {
