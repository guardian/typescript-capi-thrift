...
export const CommentElementFieldsCodec: thrift.IStructCodec<
  ICommentElementFieldsArgs,
  ICommentElementFields
> = {
...
export class CommentElementFields extends thrift.StructLike
  implements ICommentElementFields {
  ...
  public static write(
    args: ICommentElementFieldsArgs,
