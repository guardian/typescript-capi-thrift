...
export const ContentAtomElementFieldsCodec: thrift.IStructCodec<
  IContentAtomElementFieldsArgs,
  IContentAtomElementFields
> = {
  encode(args: IContentAtomElementFieldsArgs, output: thrift.TProtocol): void {
    ...
    if (obj.atomId != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[atomId] is unset!'
      );
    }
  ...
  decode(input: thrift.TProtocol): IContentAtomElementFields {
    ...
    if (_args.atomId !== undefined && _args.atomType !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read ContentAtomElementFields from input'
      );
    }
  },
};
export class ContentAtomElementFields extends thrift.StructLike
  implements IContentAtomElementFields {
  ...
  public static read(input: thrift.TProtocol): ContentAtomElementFields {
    return new ContentAtomElementFields(
      ContentAtomElementFieldsCodec.decode(input)
    );
  }
  public static write(
    args: IContentAtomElementFieldsArgs,
