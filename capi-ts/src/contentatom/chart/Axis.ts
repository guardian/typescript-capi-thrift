...
export interface IAxis {
  scale: Array<number>;
  range: __NAMESPACE__.IRange;
}
export interface IAxisArgs {
  scale: Array<number>;
  range: __NAMESPACE__.IRangeArgs;
}
export const AxisCodec: thrift.IStructCodec<IAxisArgs, IAxis> = {
  encode(args: IAxisArgs, output: thrift.TProtocol): void {
    ...
    if (obj.range != null) {
      ...
      __NAMESPACE__.RangeCodec.encode(obj.range, output);
      output.writeFieldEnd();
    } else {
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[range] is unset!'
      );
    }
  ...
  decode(input: thrift.TProtocol): IAxis {
    ...
    if (_args.scale !== undefined && _args.range !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Axis from input'
      );
    }
  },
};
export class Axis extends thrift.StructLike implements IAxis {
  ...
  public range: __NAMESPACE__.IRange;
  ...
  constructor(args: IAxisArgs) {
    ...
    if (args.range != null) {
      const value_6: __NAMESPACE__.IRange = new __NAMESPACE__.Range(args.range);
      this.range = value_6;
    } else {
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
