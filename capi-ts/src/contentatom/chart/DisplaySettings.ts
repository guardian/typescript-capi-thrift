...
export const DisplaySettingsCodec: thrift.IStructCodec<
  IDisplaySettingsArgs,
  IDisplaySettings
> = {
  ...
  decode(input: thrift.TProtocol): IDisplaySettings {
    ...
    if (_args.showHeadline !== undefined && _args.showSource !== undefined) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Unable to read DisplaySettings from input'
      );
    }
  },
};
export class DisplaySettings extends thrift.StructLike
