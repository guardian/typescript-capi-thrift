...
export const QAndAAtomCodec: thrift.IStructCodec<IQAndAAtomArgs, IQAndAAtom> = {
  ...
  decode(input: thrift.TProtocol): IQAndAAtom {
      ...
      switch (fieldId) {
        ...
        case 3:
          if (fieldType === thrift.TType.STRUCT) {
            const value_2: com_gu_contentatom_thrift.IImage = com_gu_contentatom_thrift.ImageCodec.decode(
              input
            );
        ...
        case 4:
          if (fieldType === thrift.TType.STRUCT) {
            const value_3: __NAMESPACE__.IQAndAItem = __NAMESPACE__.QAndAItemCodec.decode(
              input
            );
            _args.item = value_3;
          } else {
        ...
        case 5:
          if (fieldType === thrift.TType.STRUCT) {
            const value_4: contentatom_storyquestions.IQuestion = contentatom_storyquestions.QuestionCodec.decode(
              input
            );
    ...
    if (_args.item !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read QAndAAtom from input'
      );
    }
  },
};
export class QAndAAtom extends thrift.StructLike implements IQAndAAtom {
  ...
  constructor(args: IQAndAAtomArgs) {
    ...
    if (args.eventImage != null) {
      const value_6: com_gu_contentatom_thrift.IImage = new com_gu_contentatom_thrift.Image(
        args.eventImage
      );
      this.eventImage = value_6;
    }
    if (args.item != null) {
      const value_7: __NAMESPACE__.IQAndAItem = new __NAMESPACE__.QAndAItem(
        args.item
      );
      this.item = value_7;
    } else {
    ...
    if (args.question != null) {
      const value_8: contentatom_storyquestions.IQuestion = new contentatom_storyquestions.Question(
        args.question
      );
