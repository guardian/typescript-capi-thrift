...
export const ReviewAtomCodec: thrift.IStructCodec<
  IReviewAtomArgs,
  IReviewAtom
> = {
  encode(args: IReviewAtomArgs, output: thrift.TProtocol): void {
    ...
    if (obj.reviewType != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[reviewType] is unset!'
      );
    }
    if (obj.reviewer != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[reviewer] is unset!'
      );
    }
    if (obj.rating != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[rating] is unset!'
      );
    }
    if (obj.reviewSnippet != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[reviewSnippet] is unset!'
      );
    }
    if (obj.entityId != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[entityId] is unset!'
      );
    }
    ...
    if (obj.images != null) {
      ...
      obj.images.forEach(
        (value_1: com_gu_contentatom_thrift.IImageArgs): void => {
  ...
  decode(input: thrift.TProtocol): IReviewAtom {
      ...
      switch (fieldId) {
        ...
        case 3:
          if (fieldType === thrift.TType.STRUCT) {
            const value_4: __NAMESPACE__.IRating = __NAMESPACE__.RatingCodec.decode(
              input
            );
        ...
        case 7:
          if (fieldType === thrift.TType.STRUCT) {
            const value_8: com_gu_contententity_thrift_entity_game.IGame = com_gu_contententity_thrift_entity_game.GameCodec.decode(
              input
            );
            _args.game = value_8;
          } else {
        ...
        case 8:
          if (fieldType === thrift.TType.STRUCT) {
            const value_9: com_gu_contententity_thrift_entity_film.IFilm = com_gu_contententity_thrift_entity_film.FilmCodec.decode(
              input
            );
            _args.film = value_9;
          } else {
        ...
        case 10:
          if (fieldType === thrift.TType.LIST) {
            const value_11: Array<com_gu_contentatom_thrift.IImage> = new Array<
              com_gu_contentatom_thrift.IImage
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_12: com_gu_contentatom_thrift.IImage = com_gu_contentatom_thrift.ImageCodec.decode(
                input
              );
    ...
    input.readStructEnd();
    if (
      _args.reviewType !== undefined &&
      _args.reviewer !== undefined &&
      _args.rating !== undefined &&
      _args.reviewSnippet !== undefined &&
      _args.entityId !== undefined
    ) {
      return {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read ReviewAtom from input'
      );
    }
  },
};
export class ReviewAtom extends thrift.StructLike implements IReviewAtom {
  ...
  constructor(args: IReviewAtomArgs) {
    ...
    if (args.rating != null) {
      const value_15: __NAMESPACE__.IRating = new __NAMESPACE__.Rating(
        args.rating
      );
    ...
    if (args.restaurant != null) {
      const value_18: com_gu_contententity_thrift_entity_restaurant.IRestaurant = new com_gu_contententity_thrift_entity_restaurant.Restaurant(
        args.restaurant
      );
      this.restaurant = value_18;
    }
    if (args.game != null) {
      const value_19: com_gu_contententity_thrift_entity_game.IGame = new com_gu_contententity_thrift_entity_game.Game(
        args.game
      );
      this.game = value_19;
    }
    if (args.film != null) {
      const value_20: com_gu_contententity_thrift_entity_film.IFilm = new com_gu_contententity_thrift_entity_film.Film(
        args.film
      );
      this.film = value_20;
    }
    ...
    if (args.images != null) {
      const value_22: Array<com_gu_contentatom_thrift.IImage> = new Array<
        com_gu_contentatom_thrift.IImage
      >();
      args.images.forEach(
        (value_23: com_gu_contentatom_thrift.IImageArgs): void => {
          const value_24: com_gu_contentatom_thrift.IImage = new com_gu_contentatom_thrift.Image(
            value_23
          );
