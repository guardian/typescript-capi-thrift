...
export const RatingCodec: thrift.IStructCodec<IRatingArgs, IRating> = {
  encode(args: IRatingArgs, output: thrift.TProtocol): void {
    ...
    if (obj.maxRating != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[maxRating] is unset!'
      );
    }
    if (obj.actualRating != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[actualRating] is unset!'
      );
    }
    if (obj.minRating != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[minRating] is unset!'
      );
    }
  ...
  decode(input: thrift.TProtocol): IRating {
    ...
    input.readStructEnd();
    if (
      _args.maxRating !== undefined &&
      _args.actualRating !== undefined &&
      _args.minRating !== undefined
    ) {
      return {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Rating from input'
      );
    }
  },
};
