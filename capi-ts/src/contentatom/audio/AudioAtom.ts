...
export interface IAudioAtom {
  ...
  duration: number;
  contentId: string;
  offPlatformLinks?: __NAMESPACE__.IOffPlatform;
}
export interface IAudioAtomArgs {
  ...
  duration: number;
  contentId: string;
  offPlatformLinks?: __NAMESPACE__.IOffPlatformArgs;
}
export const AudioAtomCodec: thrift.IStructCodec<IAudioAtomArgs, IAudioAtom> = {
  encode(args: IAudioAtomArgs, output: thrift.TProtocol): void {
    ...
    if (obj.kicker != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[kicker] is unset!'
      );
    }
    if (obj.coverUrl != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[coverUrl] is unset!'
      );
    }
    if (obj.trackUrl != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[trackUrl] is unset!'
      );
    }
    ...
    if (obj.contentId != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[contentId] is unset!'
      );
    }
    if (obj.offPlatformLinks != null) {
      output.writeFieldBegin('offPlatformLinks', thrift.TType.STRUCT, 6);
      __NAMESPACE__.OffPlatformCodec.encode(obj.offPlatformLinks, output);
      output.writeFieldEnd();
    }
  ...
  decode(input: thrift.TProtocol): IAudioAtom {
      ...
      switch (fieldId) {
        ...
        case 6:
          if (fieldType === thrift.TType.STRUCT) {
            const value_6: __NAMESPACE__.IOffPlatform = __NAMESPACE__.OffPlatformCodec.decode(
              input
            );
    ...
    input.readStructEnd();
    if (
      _args.kicker !== undefined &&
      _args.coverUrl !== undefined &&
      _args.trackUrl !== undefined &&
      _args.duration !== undefined &&
      _args.contentId !== undefined
    ) {
      return {
        kicker: _args.kicker,
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read AudioAtom from input'
      );
    }
  },
};
export class AudioAtom extends thrift.StructLike implements IAudioAtom {
  ...
  public offPlatformLinks?: __NAMESPACE__.IOffPlatform;
  ...
  constructor(args: IAudioAtomArgs) {
    ...
    if (args.offPlatformLinks != null) {
      const value_12: __NAMESPACE__.IOffPlatform = new __NAMESPACE__.OffPlatform(
        args.offPlatformLinks
      );
