...
export const TagsCodec: thrift.IStructCodec<ITagsArgs, ITags> = {
  encode(args: ITagsArgs, output: thrift.TProtocol): void {
    ...
    if (obj.celebration != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[celebration] is unset!'
      );
    }
    if (obj.dietary != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[dietary] is unset!'
      );
    }
  ...
  decode(input: thrift.TProtocol): ITags {
    ...
    input.readStructEnd();
    if (
      _args.cuisine !== undefined &&
      _args.category !== undefined &&
      _args.celebration !== undefined &&
      _args.dietary !== undefined
    ) {
      return {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Tags from input'
      );
    }
  },
};
