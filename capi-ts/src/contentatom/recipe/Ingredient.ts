...
export interface IIngredient {
  ...
  comment?: string;
  quantity?: number;
  quantityRange?: __NAMESPACE__.IRange;
  unit?: string;
}
export interface IIngredientArgs {
  ...
  comment?: string;
  quantity?: number;
  quantityRange?: __NAMESPACE__.IRangeArgs;
  unit?: string;
}
export const IngredientCodec: thrift.IStructCodec<
  IIngredientArgs,
  IIngredient
> = {
  encode(args: IIngredientArgs, output: thrift.TProtocol): void {
    ...
    if (obj.quantityRange != null) {
      ...
      __NAMESPACE__.RangeCodec.encode(obj.quantityRange, output);
      output.writeFieldEnd();
    }
    if (obj.unit != null) {
  ...
  decode(input: thrift.TProtocol): IIngredient {
      ...
      switch (fieldId) {
        ...
        case 4:
          if (fieldType === thrift.TType.STRUCT) {
            const value_4: __NAMESPACE__.IRange = __NAMESPACE__.RangeCodec.decode(
              input
            );
    ...
    if (_args.item !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Ingredient from input'
      );
    }
  },
};
export class Ingredient extends thrift.StructLike implements IIngredient {
  ...
  public quantityRange?: __NAMESPACE__.IRange;
  public unit?: string;
  ...
  constructor(args: IIngredientArgs) {
    ...
    if (args.quantityRange != null) {
      const value_9: __NAMESPACE__.IRange = new __NAMESPACE__.Range(
        args.quantityRange
      );
