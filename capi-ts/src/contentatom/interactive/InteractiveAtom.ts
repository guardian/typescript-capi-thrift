...
export const InteractiveAtomCodec: thrift.IStructCodec<
  IInteractiveAtomArgs,
  IInteractiveAtom
> = {
  ...
  decode(input: thrift.TProtocol): IInteractiveAtom {
    ...
    if (
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read InteractiveAtom from input'
      );
    }
  },
};
export class InteractiveAtom extends thrift.StructLike
  implements IInteractiveAtom {
  public type: string;
  public title: string;
  public css: string;
  public html: string;
