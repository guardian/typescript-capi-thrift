...
export interface IExplainerAtom {
  title: string;
  body: string;
  displayType: __NAMESPACE__.DisplayType;
  tags?: Array<string>;
}
...
export const ExplainerAtomCodec: thrift.IStructCodec<
  IExplainerAtomArgs,
  IExplainerAtom
> = {
  encode(args: IExplainerAtomArgs, output: thrift.TProtocol): void {
    ...
    if (obj.displayType != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[displayType] is unset!'
      );
    }
    if (obj.tags != null) {
  ...
  decode(input: thrift.TProtocol): IExplainerAtom {
      ...
      switch (fieldId) {
        ...
        case 4:
          if (fieldType === thrift.TType.I32) {
            const value_4: __NAMESPACE__.DisplayType = input.readI32();
    ...
    if (
      ...
      _args.body !== undefined &&
      _args.displayType !== undefined
    ) {
      return {
        title: _args.title,
        body: _args.body,
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read ExplainerAtom from input'
      );
    }
  },
};
export class ExplainerAtom extends thrift.StructLike implements IExplainerAtom {
  public title: string;
  public body: string;
  public displayType: __NAMESPACE__.DisplayType;
  ...
  constructor(args: IExplainerAtomArgs) {
    ...
    if (args.displayType != null) {
      const value_9: __NAMESPACE__.DisplayType = args.displayType;
