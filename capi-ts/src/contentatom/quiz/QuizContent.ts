...
export const QuizContentCodec: thrift.IStructCodec<
  IQuizContentArgs,
  IQuizContent
> = {
  ...
  decode(input: thrift.TProtocol): IQuizContent {
      ...
      switch (fieldId) {
        case 1:
          if (fieldType === thrift.TType.LIST) {
            const value_2: Array<__NAMESPACE__.IQuestion> = new Array<
              __NAMESPACE__.IQuestion
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_3: __NAMESPACE__.IQuestion = __NAMESPACE__.QuestionCodec.decode(
                input
              );
        ...
        case 2:
          if (fieldType === thrift.TType.STRUCT) {
            const value_4: __NAMESPACE__.IResultGroups = __NAMESPACE__.ResultGroupsCodec.decode(
              input
            );
        ...
        case 3:
          if (fieldType === thrift.TType.STRUCT) {
            const value_5: __NAMESPACE__.IResultBuckets = __NAMESPACE__.ResultBucketsCodec.decode(
              input
            );
    ...
    if (_args.questions !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read QuizContent from input'
      );
    }
  },
};
export class QuizContent extends thrift.StructLike implements IQuizContent {
  ...
  constructor(args: IQuizContentArgs) {
    ...
    if (args.questions != null) {
      const value_6: Array<__NAMESPACE__.IQuestion> = new Array<
        __NAMESPACE__.IQuestion
      >();
    ...
    if (args.resultGroups != null) {
      const value_7: __NAMESPACE__.IResultGroups = new __NAMESPACE__.ResultGroups(
        args.resultGroups
      );
      this.resultGroups = value_7;
    }
    if (args.resultBuckets != null) {
      const value_8: __NAMESPACE__.IResultBuckets = new __NAMESPACE__.ResultBuckets(
        args.resultBuckets
      );
