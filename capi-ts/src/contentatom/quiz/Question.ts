  ...
  encode(args: IQuestionArgs, output: thrift.TProtocol): void {
    ...
    if (obj.questionText != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[questionText] is unset!'
      );
    }
    if (obj.assets != null) {
    ...
    if (obj.answers != null) {
      ...
      obj.answers.forEach(
        (value_2: __NAMESPACE__.IAnswerArgs): void => {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[answers] is unset!'
      );
    }
    if (obj.id != null) {
  ...
  decode(input: thrift.TProtocol): IQuestion {
    ...
    while (true) {
      ...
      switch (fieldId) {
        ...
        case 3:
          if (fieldType === thrift.TType.LIST) {
            const value_6: Array<__NAMESPACE__.IAnswer> = new Array<
              __NAMESPACE__.IAnswer
            >();
            const metadata_2: thrift.IThriftList = input.readListBegin();
            const size_2: number = metadata_2.size;
            for (let i_2: number = 0; i_2 < size_2; i_2++) {
              const value_7: __NAMESPACE__.IAnswer = __NAMESPACE__.AnswerCodec.decode(
                input
              );
    ...
    input.readStructEnd();
    if (
      _args.questionText !== undefined &&
      _args.assets !== undefined &&
      _args.answers !== undefined &&
      _args.id !== undefined
    ) {
      return {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Question from input'
      );
    }
  },
};
export class Question extends thrift.StructLike implements IQuestion {
  ...
  constructor(args: IQuestionArgs) {
    ...
    if (args.assets != null) {
      const value_10: Array<__NAMESPACE__.IAsset> = new Array<
        __NAMESPACE__.IAsset
      >();
      args.assets.forEach(
    ...
    if (args.answers != null) {
      const value_11: Array<__NAMESPACE__.IAnswer> = new Array<
        __NAMESPACE__.IAnswer
      >();
      args.answers.forEach(
        (value_15: __NAMESPACE__.IAnswerArgs): void => {
          const value_16: __NAMESPACE__.IAnswer = new __NAMESPACE__.Answer(
            value_15
          );
