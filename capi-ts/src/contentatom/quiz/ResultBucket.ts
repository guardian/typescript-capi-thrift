...
export const ResultBucketCodec: thrift.IStructCodec<
  IResultBucketArgs,
  IResultBucket
> = {
  encode(args: IResultBucketArgs, output: thrift.TProtocol): void {
    ...
    if (obj.description != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[description] is unset!'
      );
    }
    if (obj.title != null) {
  ...
  decode(input: thrift.TProtocol): IResultBucket {
      ...
      switch (fieldId) {
        case 1:
          if (fieldType === thrift.TType.LIST) {
            const value_2: Array<__NAMESPACE__.IAsset> = new Array<
              __NAMESPACE__.IAsset
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_3: __NAMESPACE__.IAsset = __NAMESPACE__.AssetCodec.decode(
                input
              );
    ...
    if (
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read ResultBucket from input'
      );
    }
  },
};
export class ResultBucket extends thrift.StructLike implements IResultBucket {
  ...
  constructor(args: IResultBucketArgs) {
    super();
    if (args.assets != null) {
      const value_8: Array<__NAMESPACE__.IAsset> = new Array<
        __NAMESPACE__.IAsset
      >();
      args.assets.forEach(
