...
export interface IMediaAtom {
  ...
  title: string;
  category: __NAMESPACE__.Category;
  plutoProjectId?: string;
  duration?: thrift.Int64;
  source?: string;
  posterUrl?: string;
  description?: string;
  metadata?: __NAMESPACE__.IMetadata;
  posterImage?: com_gu_contentatom_thrift.IImage;
  trailText?: string;
  byline?: Array<string>;
  commissioningDesks?: Array<string>;
  keywords?: Array<string>;
  trailImage?: com_gu_contentatom_thrift.IImage;
...
export interface IMediaAtomArgs {
  ...
  posterUrl?: string;
  description?: string;
  metadata?: __NAMESPACE__.IMetadataArgs;
  posterImage?: com_gu_contentatom_thrift.IImageArgs;
  trailText?: string;
  byline?: Array<string>;
  commissioningDesks?: Array<string>;
  keywords?: Array<string>;
  trailImage?: com_gu_contentatom_thrift.IImageArgs;
  optimisedForWeb?: boolean;
  commentsEnabled?: boolean;
  suppressRelatedContent?: boolean;
}
export const MediaAtomCodec: thrift.IStructCodec<IMediaAtomArgs, IMediaAtom> = {
  encode(args: IMediaAtomArgs, output: thrift.TProtocol): void {
    const obj = {
      assets: args.assets,
      activeVersion:
        typeof args.activeVersion === 'number'
          ? new thrift.Int64(args.activeVersion)
          : typeof args.activeVersion === 'string'
          ? thrift.Int64.fromDecimalString(args.activeVersion)
          : args.activeVersion,
      title: args.title,
      ...
      duration:
        typeof args.duration === 'number'
          ? new thrift.Int64(args.duration)
          : typeof args.duration === 'string'
          ? thrift.Int64.fromDecimalString(args.duration)
          : args.duration,
      source: args.source,
    ...
    if (obj.activeVersion != null) {
      ...
      output.writeI64(
        typeof obj.activeVersion === 'number'
          ? new thrift.Int64(obj.activeVersion)
          : typeof obj.activeVersion === 'string'
          ? thrift.Int64.fromDecimalString(obj.activeVersion)
          : obj.activeVersion
      );
      output.writeFieldEnd();
    }
    ...
    if (obj.category != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[category] is unset!'
      );
    }
    ...
    if (obj.duration != null) {
      ...
      output.writeI64(
        typeof obj.duration === 'number'
          ? new thrift.Int64(obj.duration)
          : typeof obj.duration === 'string'
          ? thrift.Int64.fromDecimalString(obj.duration)
          : obj.duration
      );
      output.writeFieldEnd();
    }
    ...
    if (obj.metadata != null) {
      ...
      __NAMESPACE__.MetadataCodec.encode(obj.metadata, output);
      output.writeFieldEnd();
    }
    if (obj.posterImage != null) {
      output.writeFieldBegin('posterImage', thrift.TType.STRUCT, 12);
      com_gu_contentatom_thrift.ImageCodec.encode(obj.posterImage, output);
      output.writeFieldEnd();
    }
    ...
    if (obj.trailImage != null) {
      ...
      com_gu_contentatom_thrift.ImageCodec.encode(obj.trailImage, output);
      output.writeFieldEnd();
    }
  ...
  decode(input: thrift.TProtocol): IMediaAtom {
      ...
      switch (fieldId) {
        case 2:
          if (fieldType === thrift.TType.LIST) {
            const value_5: Array<__NAMESPACE__.IAsset> = new Array<
              __NAMESPACE__.IAsset
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_6: __NAMESPACE__.IAsset = __NAMESPACE__.AssetCodec.decode(
                input
              );
        ...
        case 5:
          if (fieldType === thrift.TType.I32) {
            const value_9: __NAMESPACE__.Category = input.readI32();
        ...
        case 11:
          if (fieldType === thrift.TType.STRUCT) {
            const value_15: __NAMESPACE__.IMetadata = __NAMESPACE__.MetadataCodec.decode(
              input
            );
        ...
        case 18:
          if (fieldType === thrift.TType.STRUCT) {
            const value_24: com_gu_contentatom_thrift.IImage = com_gu_contentatom_thrift.ImageCodec.decode(
              input
            );
    ...
    if (
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read MediaAtom from input'
      );
    }
  },
};
export class MediaAtom extends thrift.StructLike implements IMediaAtom {
  ...
  public title: string;
  public category: __NAMESPACE__.Category;
  public plutoProjectId?: string;
  public duration?: thrift.Int64;
  public source?: string;
  public posterUrl?: string;
  public description?: string;
  public metadata?: __NAMESPACE__.IMetadata;
  public posterImage?: com_gu_contentatom_thrift.IImage;
  public trailText?: string;
  public byline?: Array<string>;
  public commissioningDesks?: Array<string>;
  public keywords?: Array<string>;
  public trailImage?: com_gu_contentatom_thrift.IImage;
  ...
  constructor(args: IMediaAtomArgs) {
    super();
    if (args.assets != null) {
      const value_28: Array<__NAMESPACE__.IAsset> = new Array<
        __NAMESPACE__.IAsset
      >();
      args.assets.forEach(
        (value_47: __NAMESPACE__.IAssetArgs): void => {
          const value_48: __NAMESPACE__.IAsset = new __NAMESPACE__.Asset(
            value_47
          );
    ...
    if (args.category != null) {
      const value_31: __NAMESPACE__.Category = args.category;
    ...
    if (args.metadata != null) {
      const value_37: __NAMESPACE__.IMetadata = new __NAMESPACE__.Metadata(
        args.metadata
      );
      this.metadata = value_37;
    }
    if (args.posterImage != null) {
      const value_38: com_gu_contentatom_thrift.IImage = new com_gu_contentatom_thrift.Image(
        args.posterImage
      );
    ...
    if (args.keywords != null) {
      ...
      args.keywords.forEach(
        (value_53: string): void => {
    ...
    if (args.trailImage != null) {
      const value_43: com_gu_contentatom_thrift.IImage = new com_gu_contentatom_thrift.Image(
        args.trailImage
      );
