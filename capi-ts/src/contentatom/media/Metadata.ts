...
export interface IMetadata {
  ...
  channelId?: string;
  privacyStatus?: __NAMESPACE__.PrivacyStatus;
  expiryDate?: thrift.Int64;
  pluto?: __NAMESPACE__.IPlutoData;
  youtube?: __NAMESPACE__.IYoutubeData;
}
export interface IMetadataArgs {
  ...
  pluto?: __NAMESPACE__.IPlutoDataArgs;
  youtube?: __NAMESPACE__.IYoutubeDataArgs;
}
export const MetadataCodec: thrift.IStructCodec<IMetadataArgs, IMetadata> = {
  encode(args: IMetadataArgs, output: thrift.TProtocol): void {
    const obj = {
      ...
      expiryDate:
        typeof args.expiryDate === 'number'
          ? new thrift.Int64(args.expiryDate)
          : typeof args.expiryDate === 'string'
          ? thrift.Int64.fromDecimalString(args.expiryDate)
          : args.expiryDate,
      pluto: args.pluto,
    ...
    if (obj.expiryDate != null) {
      ...
      output.writeI64(
        typeof obj.expiryDate === 'number'
          ? new thrift.Int64(obj.expiryDate)
          : typeof obj.expiryDate === 'string'
          ? thrift.Int64.fromDecimalString(obj.expiryDate)
          : obj.expiryDate
      );
      output.writeFieldEnd();
    }
    if (obj.pluto != null) {
      ...
      __NAMESPACE__.PlutoDataCodec.encode(obj.pluto, output);
      output.writeFieldEnd();
    }
    if (obj.youtube != null) {
      output.writeFieldBegin('youtube', thrift.TType.STRUCT, 9);
      __NAMESPACE__.YoutubeDataCodec.encode(obj.youtube, output);
      output.writeFieldEnd();
    }
      ...
      switch (fieldId) {
        ...
        case 6:
          if (fieldType === thrift.TType.I32) {
            const value_8: __NAMESPACE__.PrivacyStatus = input.readI32();
        ...
        case 8:
          if (fieldType === thrift.TType.STRUCT) {
            const value_10: __NAMESPACE__.IPlutoData = __NAMESPACE__.PlutoDataCodec.decode(
              input
            );
        ...
        case 9:
          if (fieldType === thrift.TType.STRUCT) {
            const value_11: __NAMESPACE__.IYoutubeData = __NAMESPACE__.YoutubeDataCodec.decode(
              input
            );
...
export class Metadata extends thrift.StructLike implements IMetadata {
  ...
  public privacyStatus?: __NAMESPACE__.PrivacyStatus;
  public expiryDate?: thrift.Int64;
  public pluto?: __NAMESPACE__.IPlutoData;
  public youtube?: __NAMESPACE__.IYoutubeData;
  ...
  constructor(args: IMetadataArgs = {}) {
    ...
    if (args.privacyStatus != null) {
      const value_17: __NAMESPACE__.PrivacyStatus = args.privacyStatus;
    ...
    if (args.pluto != null) {
      const value_19: __NAMESPACE__.IPlutoData = new __NAMESPACE__.PlutoData(
        args.pluto
      );
      this.pluto = value_19;
    }
    if (args.youtube != null) {
      const value_20: __NAMESPACE__.IYoutubeData = new __NAMESPACE__.YoutubeData(
        args.youtube
      );
