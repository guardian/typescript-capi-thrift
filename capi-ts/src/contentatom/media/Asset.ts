...
export const AssetCodec: thrift.IStructCodec<IAssetArgs, IAsset> = {
  encode(args: IAssetArgs, output: thrift.TProtocol): void {
    const obj = {
      ...
      version:
        typeof args.version === 'number'
          ? new thrift.Int64(args.version)
          : typeof args.version === 'string'
          ? thrift.Int64.fromDecimalString(args.version)
          : args.version,
      id: args.id,
    ...
    if (obj.assetType != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[assetType] is unset!'
      );
    }
    if (obj.version != null) {
      ...
      output.writeI64(
        typeof obj.version === 'number'
          ? new thrift.Int64(obj.version)
          : typeof obj.version === 'string'
          ? thrift.Int64.fromDecimalString(obj.version)
          : obj.version
      );
      output.writeFieldEnd();
    } else {
    ...
    if (obj.platform != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[platform] is unset!'
      );
    }
  ...
  decode(input: thrift.TProtocol): IAsset {
    ...
    input.readStructEnd();
    if (
      _args.assetType !== undefined &&
      _args.version !== undefined &&
      _args.id !== undefined &&
      _args.platform !== undefined
    ) {
      return {
