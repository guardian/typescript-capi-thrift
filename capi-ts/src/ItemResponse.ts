...
export class ItemResponse extends thrift.StructLike implements IItemResponse {
    ...
    constructor(args: IItemResponseArgs) {
        ...
        if (args.content != null) {
            const value_61: Content.IContent = new Content.Content(args.content);
            this.content = value_61;
        }
        if (args.tag != null) {
            const value_62: Tag.ITag = new Tag.Tag(args.tag);
            this.tag = value_62;
        }
        if (args.edition != null) {
            const value_63: Edition.IEdition = new Edition.Edition(args.edition);
            this.edition = value_63;
        }
        if (args.section != null) {
            const value_64: Section.ISection = new Section.Section(args.section);
            this.section = value_64;
        }
        if (args.results != null) {
            const value_65: Array<Content.IContent> = new Array<Content.IContent>();
            args.results.forEach((value_89: Content.IContentArgs): void => {
        ...
        if (args.relatedContent != null) {
            ...
            args.relatedContent.forEach((value_91: Content.IContentArgs): void => {
        ...
        if (args.storyPackage != null) {
            ...
            args.storyPackage.forEach((value_93: Content.IContentArgs): void => {
        ...
        if (args.editorsPicks != null) {
            ...
            args.editorsPicks.forEach((value_95: Content.IContentArgs): void => {
        ...
        if (args.mostViewed != null) {
            const value_70: Array<Content.IContent> = new Array<Content.IContent>();
            args.mostViewed.forEach((value_97: Content.IContentArgs): void => {
                const value_98: Content.IContent = new Content.Content(value_97);
                value_70.push(value_98);
            });
            this.mostViewed = value_70;
        }
        if (args.leadContent != null) {
            const value_71: Array<Content.IContent> = new Array<Content.IContent>();
            args.leadContent.forEach((value_99: Content.IContentArgs): void => {
                const value_100: Content.IContent = new Content.Content(value_99);
                value_71.push(value_100);
            });
            this.leadContent = value_71;
        }
        if (args.packages != null) {
            const value_72: Array<Package.IPackage> = new Array<Package.IPackage>();
            args.packages.forEach((value_101: Package.IPackageArgs): void => {
                const value_102: Package.IPackage = new Package.Package(value_101);
