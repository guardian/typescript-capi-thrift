...
export const ItemResponseCodec: thrift.IStructCodec<
  IItemResponseArgs,
  IItemResponse
> = {
  encode(args: IItemResponseArgs, output: thrift.TProtocol): void {
    ...
    if (obj.results != null) {
      ...
      obj.results.forEach(
        (value_1: __NAMESPACE__.IContentArgs): void => {
    ...
    if (obj.relatedContent != null) {
      ...
      obj.relatedContent.forEach(
        (value_2: __NAMESPACE__.IContentArgs): void => {
    ...
    if (obj.storyPackage != null) {
      ...
      obj.storyPackage.forEach(
        (value_3: __NAMESPACE__.IContentArgs): void => {
    ...
    if (obj.editorsPicks != null) {
      ...
      obj.editorsPicks.forEach(
        (value_4: __NAMESPACE__.IContentArgs): void => {
    ...
    if (obj.mostViewed != null) {
      ...
      obj.mostViewed.forEach(
        (value_5: __NAMESPACE__.IContentArgs): void => {
    ...
    if (obj.leadContent != null) {
      ...
      obj.leadContent.forEach(
        (value_6: __NAMESPACE__.IContentArgs): void => {
    ...
    if (obj.packages != null) {
      ...
      obj.packages.forEach(
        (value_7: __NAMESPACE__.IPackageArgs): void => {
  ...
  decode(input: thrift.TProtocol): IItemResponse {
      ...
      switch (fieldId) {
        ...
        case 9:
          if (fieldType === thrift.TType.STRUCT) {
            const value_17: __NAMESPACE__.IContent = __NAMESPACE__.ContentCodec.decode(
              input
            );
        ...
        case 10:
          if (fieldType === thrift.TType.STRUCT) {
            const value_18: __NAMESPACE__.ITag = __NAMESPACE__.TagCodec.decode(
              input
            );
            _args.tag = value_18;
          } else {
        ...
        case 11:
          if (fieldType === thrift.TType.STRUCT) {
            const value_19: __NAMESPACE__.IEdition = __NAMESPACE__.EditionCodec.decode(
              input
            );
        ...
        case 12:
          if (fieldType === thrift.TType.STRUCT) {
            const value_20: __NAMESPACE__.ISection = __NAMESPACE__.SectionCodec.decode(
              input
            );
        ...
        case 13:
          if (fieldType === thrift.TType.LIST) {
            const value_21: Array<__NAMESPACE__.IContent> = new Array<
              __NAMESPACE__.IContent
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_22: __NAMESPACE__.IContent = __NAMESPACE__.ContentCodec.decode(
                input
              );
        ...
        case 14:
          if (fieldType === thrift.TType.STRUCT) {
            const value_23: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
              input
            );
            _args.quiz = value_23;
          } else {
        ...
        case 15:
          if (fieldType === thrift.TType.LIST) {
            const value_24: Array<__NAMESPACE__.IContent> = new Array<
              __NAMESPACE__.IContent
            >();
            const metadata_2: thrift.IThriftList = input.readListBegin();
            const size_2: number = metadata_2.size;
            for (let i_2: number = 0; i_2 < size_2; i_2++) {
              const value_25: __NAMESPACE__.IContent = __NAMESPACE__.ContentCodec.decode(
                input
              );
        ...
        case 16:
          if (fieldType === thrift.TType.LIST) {
            const value_26: Array<__NAMESPACE__.IContent> = new Array<
              __NAMESPACE__.IContent
            >();
            const metadata_3: thrift.IThriftList = input.readListBegin();
            const size_3: number = metadata_3.size;
            for (let i_3: number = 0; i_3 < size_3; i_3++) {
              const value_27: __NAMESPACE__.IContent = __NAMESPACE__.ContentCodec.decode(
                input
              );
        ...
        case 17:
          if (fieldType === thrift.TType.LIST) {
            const value_28: Array<__NAMESPACE__.IContent> = new Array<
              __NAMESPACE__.IContent
            >();
            const metadata_4: thrift.IThriftList = input.readListBegin();
            const size_4: number = metadata_4.size;
            for (let i_4: number = 0; i_4 < size_4; i_4++) {
              const value_29: __NAMESPACE__.IContent = __NAMESPACE__.ContentCodec.decode(
                input
              );
        ...
        case 18:
          if (fieldType === thrift.TType.LIST) {
            const value_30: Array<__NAMESPACE__.IContent> = new Array<
              __NAMESPACE__.IContent
            >();
            const metadata_5: thrift.IThriftList = input.readListBegin();
            const size_5: number = metadata_5.size;
            for (let i_5: number = 0; i_5 < size_5; i_5++) {
              const value_31: __NAMESPACE__.IContent = __NAMESPACE__.ContentCodec.decode(
                input
              );
        ...
        case 19:
          if (fieldType === thrift.TType.LIST) {
            const value_32: Array<__NAMESPACE__.IContent> = new Array<
              __NAMESPACE__.IContent
            >();
            const metadata_6: thrift.IThriftList = input.readListBegin();
            const size_6: number = metadata_6.size;
            for (let i_6: number = 0; i_6 < size_6; i_6++) {
              const value_33: __NAMESPACE__.IContent = __NAMESPACE__.ContentCodec.decode(
                input
              );
        ...
        case 20:
          if (fieldType === thrift.TType.LIST) {
            const value_34: Array<__NAMESPACE__.IPackage> = new Array<
              __NAMESPACE__.IPackage
            >();
            ...
            for (let i_7: number = 0; i_7 < size_7; i_7++) {
              const value_35: __NAMESPACE__.IPackage = __NAMESPACE__.PackageCodec.decode(
                input
              );
        ...
        case 21:
          if (fieldType === thrift.TType.LIST) {
            const value_36: Array<com_gu_contentatom_thrift.IAtom> = new Array<
            ...
            for (let i_8: number = 0; i_8 < size_8; i_8++) {
              const value_37: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
                input
              );
        ...
        case 23:
          if (fieldType === thrift.TType.STRUCT) {
            const value_39: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
              input
            );
        ...
        case 25:
          if (fieldType === thrift.TType.STRUCT) {
            const value_41: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
              input
            );
        ...
        case 27:
          if (fieldType === thrift.TType.STRUCT) {
            const value_43: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
              input
            );
        ...
        case 29:
          if (fieldType === thrift.TType.STRUCT) {
            const value_45: com_gu_story_model_v1.IStory = com_gu_story_model_v1.StoryCodec.decode(
              input
            );
        ...
        case 31:
          if (fieldType === thrift.TType.STRUCT) {
            const value_47: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
              input
            );
        ...
        case 33:
          if (fieldType === thrift.TType.STRUCT) {
            const value_49: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
              input
            );
        ...
        case 34:
          if (fieldType === thrift.TType.STRUCT) {
            const value_50: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
              input
            );
        ...
        case 35:
          if (fieldType === thrift.TType.STRUCT) {
            const value_51: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
              input
            );
        ...
        case 36:
          if (fieldType === thrift.TType.STRUCT) {
            const value_52: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
              input
            );
    ...
    if (_args.status !== undefined && _args.userTier !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read ItemResponse from input'
      );
    }
  },
};
export class ItemResponse extends thrift.StructLike implements IItemResponse {
  ...
  constructor(args: IItemResponseArgs) {
    ...
    if (args.content != null) {
      const value_61: __NAMESPACE__.IContent = new __NAMESPACE__.Content(
        args.content
      );
    ...
    if (args.edition != null) {
      const value_63: __NAMESPACE__.IEdition = new __NAMESPACE__.Edition(
        args.edition
      );
      this.edition = value_63;
    }
    if (args.section != null) {
      const value_64: __NAMESPACE__.ISection = new __NAMESPACE__.Section(
        args.section
      );
      this.section = value_64;
    }
    if (args.results != null) {
      const value_65: Array<__NAMESPACE__.IContent> = new Array<
        __NAMESPACE__.IContent
      >();
      args.results.forEach(
        (value_89: __NAMESPACE__.IContentArgs): void => {
          const value_90: __NAMESPACE__.IContent = new __NAMESPACE__.Content(
            value_89
          );
    ...
    if (args.relatedContent != null) {
      const value_67: Array<__NAMESPACE__.IContent> = new Array<
        __NAMESPACE__.IContent
      >();
      args.relatedContent.forEach(
        (value_91: __NAMESPACE__.IContentArgs): void => {
          const value_92: __NAMESPACE__.IContent = new __NAMESPACE__.Content(
            value_91
          );
    ...
    if (args.storyPackage != null) {
      const value_68: Array<__NAMESPACE__.IContent> = new Array<
        __NAMESPACE__.IContent
      >();
      args.storyPackage.forEach(
        (value_93: __NAMESPACE__.IContentArgs): void => {
          const value_94: __NAMESPACE__.IContent = new __NAMESPACE__.Content(
            value_93
          );
    ...
    if (args.editorsPicks != null) {
      const value_69: Array<__NAMESPACE__.IContent> = new Array<
        __NAMESPACE__.IContent
      >();
      args.editorsPicks.forEach(
        (value_95: __NAMESPACE__.IContentArgs): void => {
          const value_96: __NAMESPACE__.IContent = new __NAMESPACE__.Content(
            value_95
          );
    ...
    if (args.mostViewed != null) {
      const value_70: Array<__NAMESPACE__.IContent> = new Array<
        __NAMESPACE__.IContent
      >();
      args.mostViewed.forEach(
        (value_97: __NAMESPACE__.IContentArgs): void => {
          const value_98: __NAMESPACE__.IContent = new __NAMESPACE__.Content(
            value_97
          );
    ...
    if (args.leadContent != null) {
      const value_71: Array<__NAMESPACE__.IContent> = new Array<
        __NAMESPACE__.IContent
      >();
      args.leadContent.forEach(
        (value_99: __NAMESPACE__.IContentArgs): void => {
          const value_100: __NAMESPACE__.IContent = new __NAMESPACE__.Content(
            value_99
          );
    ...
    if (args.packages != null) {
      const value_72: Array<__NAMESPACE__.IPackage> = new Array<
        __NAMESPACE__.IPackage
      >();
      args.packages.forEach(
        (value_101: __NAMESPACE__.IPackageArgs): void => {
          const value_102: __NAMESPACE__.IPackage = new __NAMESPACE__.Package(
            value_101
          );
    ...
    if (args.viewpoints != null) {
      const value_73: Array<com_gu_contentatom_thrift.IAtom> = new Array<
        com_gu_contentatom_thrift.IAtom
      >();
      args.viewpoints.forEach(
        (value_103: com_gu_contentatom_thrift.IAtomArgs): void => {
          const value_104: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(
            value_103
          );
    ...
    if (args.explainer != null) {
      const value_75: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(
        args.explainer
      );
    ...
    if (args.interactive != null) {
      const value_77: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(
        args.interactive
      );
    ...
    if (args.recipe != null) {
      const value_79: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(
        args.recipe
      );
    ...
    if (args.story != null) {
      const value_81: com_gu_story_model_v1.IStory = new com_gu_story_model_v1.Story(
        args.story
      );
      this.story = value_81;
    }
    ...
    if (args.guide != null) {
      const value_83: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(
        args.guide
      );
      this.guide = value_83;
    }
    ...
    if (args.timeline != null) {
      const value_85: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(
        args.timeline
      );
    ...
    if (args.chart != null) {
      const value_87: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(
        args.chart
      );
      this.chart = value_87;
    }
