...
export const WitnessElementFieldsCodec: thrift.IStructCodec<
  IWitnessElementFieldsArgs,
  IWitnessElementFields
> = {
      ...
      switch (fieldId) {
        ...
        case 19:
          if (fieldType === thrift.TType.STRUCT) {
            const value_19: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(
              input
            );
...
export class WitnessElementFields extends thrift.StructLike
  implements IWitnessElementFields {
  public url?: string;
  ...
  constructor(args: IWitnessElementFieldsArgs = {}) {
    ...
    if (args.dateCreated != null) {
      const value_45: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.dateCreated
      );
  ...
  public static write(
    args: IWitnessElementFieldsArgs,
