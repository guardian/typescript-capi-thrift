...
export interface IPodcast {
  ...
  explicit: boolean;
  image?: string;
  categories?: Array<__NAMESPACE__.IPodcastCategory>;
  podcastType?: string;
...
export interface IPodcastArgs {
  ...
  explicit: boolean;
  image?: string;
  categories?: Array<__NAMESPACE__.IPodcastCategoryArgs>;
  podcastType?: string;
  googlePodcastsUrl?: string;
  spotifyUrl?: string;
}
export const PodcastCodec: thrift.IStructCodec<IPodcastArgs, IPodcast> = {
  encode(args: IPodcastArgs, output: thrift.TProtocol): void {
    ...
    if (obj.linkUrl != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[linkUrl] is unset!'
      );
    }
    if (obj.copyright != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[copyright] is unset!'
      );
    }
    if (obj.author != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[author] is unset!'
      );
    }
    ...
    if (obj.explicit != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[explicit] is unset!'
      );
    }
    if (obj.image != null) {
    ...
    if (obj.categories != null) {
      ...
      obj.categories.forEach(
        (value_1: __NAMESPACE__.IPodcastCategoryArgs): void => {
          __NAMESPACE__.PodcastCategoryCodec.encode(value_1, output);
        }
      );
      output.writeListEnd();
      output.writeFieldEnd();
  ...
  decode(input: thrift.TProtocol): IPodcast {
      ...
      switch (fieldId) {
        ...
        case 7:
          if (fieldType === thrift.TType.LIST) {
            const value_8: Array<__NAMESPACE__.IPodcastCategory> = new Array<
              __NAMESPACE__.IPodcastCategory
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_9: __NAMESPACE__.IPodcastCategory = __NAMESPACE__.PodcastCategoryCodec.decode(
                input
              );
    ...
    input.readStructEnd();
    if (
      _args.linkUrl !== undefined &&
      _args.copyright !== undefined &&
      _args.author !== undefined &&
      _args.explicit !== undefined
    ) {
      return {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Podcast from input'
      );
    }
  },
};
export class Podcast extends thrift.StructLike implements IPodcast {
  ...
  public image?: string;
  public categories?: Array<__NAMESPACE__.IPodcastCategory>;
  ...
  constructor(args: IPodcastArgs) {
    ...
    if (args.categories != null) {
      const value_19: Array<__NAMESPACE__.IPodcastCategory> = new Array<
        __NAMESPACE__.IPodcastCategory
      >();
      args.categories.forEach(
        (value_23: __NAMESPACE__.IPodcastCategoryArgs): void => {
          const value_24: __NAMESPACE__.IPodcastCategory = new __NAMESPACE__.PodcastCategory(
            value_23
          );
