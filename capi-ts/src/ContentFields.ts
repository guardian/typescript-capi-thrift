...
export const ContentFieldsCodec: thrift.IStructCodec<
  IContentFieldsArgs,
  IContentFields
> = {
  encode(args: IContentFieldsArgs, output: thrift.TProtocol): void {
    ...
    if (obj.scheduledPublicationDate != null) {
      ...
      __NAMESPACE__.CapiDateTimeCodec.encode(
        obj.scheduledPublicationDate,
        output
      );
      output.writeFieldEnd();
    }
  ...
  decode(input: thrift.TProtocol): IContentFields {
    ...
    while (true) {
      ...
      switch (fieldId) {
        ...
        case 14:
          if (fieldType === thrift.TType.STRUCT) {
            const value_14: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(
              input
            );
        ...
        case 24:
          if (fieldType === thrift.TType.STRUCT) {
            const value_24: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(
              input
            );
        ...
        case 26:
          if (fieldType === thrift.TType.STRUCT) {
            const value_26: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(
              input
            );
        ...
        case 29:
          if (fieldType === thrift.TType.STRUCT) {
            const value_29: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(
              input
            );
...
export class ContentFields extends thrift.StructLike implements IContentFields {
  ...
  constructor(args: IContentFieldsArgs = {}) {
    ...
    if (args.commentCloseDate != null) {
      const value_63: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.commentCloseDate
      );
    ...
    if (args.creationDate != null) {
      const value_65: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.creationDate
      );
    ...
    if (args.firstPublicationDate != null) {
      const value_67: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.firstPublicationDate
      );
    ...
    if (args.lastModified != null) {
      const value_75: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.lastModified
      );
    ...
    if (args.newspaperEditionDate != null) {
      const value_77: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.newspaperEditionDate
      );
    ...
    if (args.scheduledPublicationDate != null) {
      const value_80: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(
        args.scheduledPublicationDate
      );
