...
export const TagsResponseCodec: thrift.IStructCodec<
  ITagsResponseArgs,
  ITagsResponse
> = {
  ...
  decode(input: thrift.TProtocol): ITagsResponse {
      ...
      switch (fieldId) {
        ...
        case 8:
          if (fieldType === thrift.TType.LIST) {
            const value_9: Array<__NAMESPACE__.ITag> = new Array<
              __NAMESPACE__.ITag
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_10: __NAMESPACE__.ITag = __NAMESPACE__.TagCodec.decode(
                input
              );
    ...
    if (
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read TagsResponse from input'
      );
    }
  },
};
export class TagsResponse extends thrift.StructLike implements ITagsResponse {
  ...
  constructor(args: ITagsResponseArgs) {
    ...
    if (args.results != null) {
      const value_18: Array<__NAMESPACE__.ITag> = new Array<
        __NAMESPACE__.ITag
      >();
