...
export const CrosswordPositionCodec: thrift.IStructCodec<
  ICrosswordPositionArgs,
  ICrosswordPosition
> = {
  ...
  decode(input: thrift.TProtocol): ICrosswordPosition {
    ...
    if (_args.x !== undefined && _args.y !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read CrosswordPosition from input'
      );
    }
  },
};
export class CrosswordPosition extends thrift.StructLike
  implements ICrosswordPosition {
  public x: number;
  public y: number;
