...
export const NotificationProvidersCodec: thrift.IStructCodec<
  INotificationProvidersArgs,
  INotificationProviders
> = {
      ...
      switch (fieldId) {
        case 1:
          if (fieldType === thrift.TType.STRUCT) {
            const value_1: __NAMESPACE__.IEmailProvider = __NAMESPACE__.EmailProviderCodec.decode(
              input
            );
            _args.email = value_1;
          } else {
...
export class NotificationProviders extends thrift.StructLike
  implements INotificationProviders {
  ...
  constructor(args: INotificationProvidersArgs = {}) {
    super();
    if (args.email != null) {
      const value_2: __NAMESPACE__.IEmailProvider = new __NAMESPACE__.EmailProvider(
        args.email
      );
      this.email = value_2;
    }
  ...
  public static write(
    args: INotificationProvidersArgs,
