...
export interface IChangeRecord {
  date: thrift.Int64;
  user?: __NAMESPACE__.IUser;
}
export interface IChangeRecordArgs {
  date: number | string | thrift.Int64;
  user?: __NAMESPACE__.IUserArgs;
}
export const ChangeRecordCodec: thrift.IStructCodec<
  IChangeRecordArgs,
  IChangeRecord
> = {
  encode(args: IChangeRecordArgs, output: thrift.TProtocol): void {
    ...
    if (obj.user != null) {
      ...
      __NAMESPACE__.UserCodec.encode(obj.user, output);
      output.writeFieldEnd();
    }
  ...
  decode(input: thrift.TProtocol): IChangeRecord {
      ...
      switch (fieldId) {
        ...
        case 2:
          if (fieldType === thrift.TType.STRUCT) {
            const value_2: __NAMESPACE__.IUser = __NAMESPACE__.UserCodec.decode(
              input
            );
            _args.user = value_2;
          } else {
    ...
    if (_args.date !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read ChangeRecord from input'
      );
    }
  },
};
export class ChangeRecord extends thrift.StructLike implements IChangeRecord {
  ...
  public user?: __NAMESPACE__.IUser;
  public readonly _annotations: thrift.IThriftAnnotations = {};
  public readonly _fieldAnnotations: thrift.IFieldAnnotations = {};
  constructor(args: IChangeRecordArgs) {
    super();
    if (args.date != null) {
      const value_3: thrift.Int64 =
        typeof args.date === 'number'
          ? new thrift.Int64(args.date)
          : typeof args.date === 'string'
          ? thrift.Int64.fromDecimalString(args.date)
    ...
    if (args.user != null) {
      const value_4: __NAMESPACE__.IUser = new __NAMESPACE__.User(args.user);
      this.user = value_4;
    }
  }
