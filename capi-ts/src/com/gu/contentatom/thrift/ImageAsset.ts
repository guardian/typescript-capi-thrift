...
export interface IImageAsset {
  mimeType?: string;
  file: string;
  dimensions?: __NAMESPACE__.IImageAssetDimensions;
  size?: thrift.Int64;
  aspectRatio?: string;
  credit?: string;
  copyright?: string;
...
export interface IImageAssetArgs {
  mimeType?: string;
  file: string;
  dimensions?: __NAMESPACE__.IImageAssetDimensionsArgs;
...
export const ImageAssetCodec: thrift.IStructCodec<
  IImageAssetArgs,
  IImageAsset
> = {
  encode(args: IImageAssetArgs, output: thrift.TProtocol): void {
    const obj = {
      ...
      size:
        typeof args.size === 'number'
          ? new thrift.Int64(args.size)
          : typeof args.size === 'string'
          ? thrift.Int64.fromDecimalString(args.size)
          : args.size,
    ...
    if (obj.file != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[file] is unset!'
      );
    }
    if (obj.dimensions != null) {
      output.writeFieldBegin('dimensions', thrift.TType.STRUCT, 3);
      __NAMESPACE__.ImageAssetDimensionsCodec.encode(obj.dimensions, output);
      output.writeFieldEnd();
    }
    if (obj.size != null) {
      ...
      output.writeI64(
        typeof obj.size === 'number'
          ? new thrift.Int64(obj.size)
          : typeof obj.size === 'string'
          ? thrift.Int64.fromDecimalString(obj.size)
          : obj.size
      );
      output.writeFieldEnd();
    }
  ...
  decode(input: thrift.TProtocol): IImageAsset {
      ...
      switch (fieldId) {
        ...
        case 3:
          if (fieldType === thrift.TType.STRUCT) {
            const value_3: __NAMESPACE__.IImageAssetDimensions = __NAMESPACE__.ImageAssetDimensionsCodec.decode(
              input
            );
    ...
    if (_args.file !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read ImageAsset from input'
      );
    }
  },
};
export class ImageAsset extends thrift.StructLike implements IImageAsset {
  ...
  public file: string;
  public dimensions?: __NAMESPACE__.IImageAssetDimensions;
  ...
  constructor(args: IImageAssetArgs) {
    ...
    if (args.dimensions != null) {
      const value_13: __NAMESPACE__.IImageAssetDimensions = new __NAMESPACE__.ImageAssetDimensions(
        args.dimensions
      );
