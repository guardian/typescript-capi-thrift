...
export const ImageCodec: thrift.IStructCodec<IImageArgs, IImage> = {
  encode(args: IImageArgs, output: thrift.TProtocol): void {
    ...
    if (obj.assets != null) {
      ...
      obj.assets.forEach(
        (value_1: __NAMESPACE__.IImageAssetArgs): void => {
    ...
    if (obj.mediaId != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[mediaId] is unset!'
      );
    }
    if (obj.source != null) {
  ...
  decode(input: thrift.TProtocol): IImage {
      ...
      switch (fieldId) {
        case 1:
          if (fieldType === thrift.TType.LIST) {
            const value_2: Array<__NAMESPACE__.IImageAsset> = new Array<
              __NAMESPACE__.IImageAsset
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_3: __NAMESPACE__.IImageAsset = __NAMESPACE__.ImageAssetCodec.decode(
                input
              );
        ...
        case 2:
          if (fieldType === thrift.TType.STRUCT) {
            const value_4: __NAMESPACE__.IImageAsset = __NAMESPACE__.ImageAssetCodec.decode(
              input
            );
    ...
    if (_args.assets !== undefined && _args.mediaId !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Image from input'
      );
    }
  },
};
export class Image extends thrift.StructLike implements IImage {
  ...
  constructor(args: IImageArgs) {
    super();
    if (args.assets != null) {
      const value_7: Array<__NAMESPACE__.IImageAsset> = new Array<
        __NAMESPACE__.IImageAsset
      >();
      args.assets.forEach(
        (value_11: __NAMESPACE__.IImageAssetArgs): void => {
          const value_12: __NAMESPACE__.IImageAsset = new __NAMESPACE__.ImageAsset(
            value_11
          );
    ...
    if (args.master != null) {
      const value_8: __NAMESPACE__.IImageAsset = new __NAMESPACE__.ImageAsset(
        args.master
      );
      this.master = value_8;
    }
