...
export const NewspaperCodec: thrift.IStructCodec<INewspaperArgs, INewspaper> = {
  encode(args: INewspaperArgs, output: thrift.TProtocol): void {
    ...
    if (obj.bookSection != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[bookSection] is unset!'
      );
    }
    if (obj.publication != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[publication] is unset!'
      );
    }
  ...
  decode(input: thrift.TProtocol): INewspaper {
    ...
    while (true) {
      ...
      switch (fieldId) {
        ...
        case 2:
          if (fieldType === thrift.TType.STRUCT) {
            const value_2: __NAMESPACE__.ITag = __NAMESPACE__.TagCodec.decode(
              input
            );
        ...
        case 3:
          if (fieldType === thrift.TType.STRUCT) {
            const value_3: __NAMESPACE__.ITag = __NAMESPACE__.TagCodec.decode(
              input
            );
    ...
    input.readStructEnd();
    if (
      _args.book !== undefined &&
      _args.bookSection !== undefined &&
      _args.publication !== undefined
    ) {
      return {
        book: _args.book,
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Newspaper from input'
      );
    }
  },
};
export class Newspaper extends thrift.StructLike implements INewspaper {
  ...
  constructor(args: INewspaperArgs) {
    ...
    if (args.bookSection != null) {
      const value_5: __NAMESPACE__.ITag = new __NAMESPACE__.Tag(
        args.bookSection
      );
    ...
    if (args.publication != null) {
      const value_6: __NAMESPACE__.ITag = new __NAMESPACE__.Tag(
        args.publication
      );
