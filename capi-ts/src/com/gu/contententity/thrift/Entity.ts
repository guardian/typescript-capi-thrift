...
export const EntityCodec: thrift.IStructCodec<IEntityArgs, IEntity> = {
    encode(args: IEntityArgs, output: thrift.TProtocol): void {
        ...
        if (obj.person != null) {
            ...
            com_gu_contententity_thrift_entity_person.PersonCodec.encode(obj.person, output);
            output.writeFieldEnd();
        }
        if (obj.film != null) {
        ...
        if (obj.place != null) {
            ...
            com_gu_contententity_thrift_entity_place.PlaceCodec.encode(obj.place, output);
            output.writeFieldEnd();
        }
        if (obj.organisation != null) {
            output.writeFieldBegin("organisation", thrift.TType.STRUCT, 9);
            com_gu_contententity_thrift_entity_organisation.OrganisationCodec.encode(obj.organisation, output);
            output.writeFieldEnd();
        }
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_4: com_gu_contententity_thrift_entity_person.IPerson = com_gu_contententity_thrift_entity_person.PersonCodec.decode(input);
                ...
                case 5:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_5: com_gu_contententity_thrift_entity_film.IFilm = com_gu_contententity_thrift_entity_film.FilmCodec.decode(input);
                        _args.film = value_5;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 6:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_6: com_gu_contententity_thrift_entity_game.IGame = com_gu_contententity_thrift_entity_game.GameCodec.decode(input);
                        _args.game = value_6;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 8:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_8: com_gu_contententity_thrift_entity_place.IPlace = com_gu_contententity_thrift_entity_place.PlaceCodec.decode(input);
                        _args.place = value_8;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 9:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_9: com_gu_contententity_thrift_entity_organisation.IOrganisation = com_gu_contententity_thrift_entity_organisation.OrganisationCodec.decode(input);
...
export class Entity extends thrift.StructLike implements IEntity {
    ...
    constructor(args: IEntityArgs) {
        ...
        if (args.person != null) {
            const value_13: com_gu_contententity_thrift_entity_person.IPerson = new com_gu_contententity_thrift_entity_person.Person(args.person);
            this.person = value_13;
        }
        if (args.film != null) {
            const value_14: com_gu_contententity_thrift_entity_film.IFilm = new com_gu_contententity_thrift_entity_film.Film(args.film);
            this.film = value_14;
        }
        if (args.game != null) {
            const value_15: com_gu_contententity_thrift_entity_game.IGame = new com_gu_contententity_thrift_entity_game.Game(args.game);
            this.game = value_15;
        }
        if (args.restaurant != null) {
            const value_16: com_gu_contententity_thrift_entity_restaurant.IRestaurant = new com_gu_contententity_thrift_entity_restaurant.Restaurant(args.restaurant);
            this.restaurant = value_16;
        }
        if (args.place != null) {
            const value_17: com_gu_contententity_thrift_entity_place.IPlace = new com_gu_contententity_thrift_entity_place.Place(args.place);
            this.place = value_17;
        }
        if (args.organisation != null) {
            const value_18: com_gu_contententity_thrift_entity_organisation.IOrganisation = new com_gu_contententity_thrift_entity_organisation.Organisation(args.organisation);
