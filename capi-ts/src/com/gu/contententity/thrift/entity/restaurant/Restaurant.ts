...
export const RestaurantCodec: thrift.IStructCodec<
  IRestaurantArgs,
  IRestaurant
> = {
  encode(args: IRestaurantArgs, output: thrift.TProtocol): void {
    ...
    if (obj.restaurantName != null) {
      ...
      throw new thrift.TProtocolException(
        ...
        'Required field[restaurantName] is unset!'
      );
    }
    ...
    if (obj.geolocation != null) {
      ...
      com_gu_contententity_thrift.GeolocationCodec.encode(
        obj.geolocation,
        output
      );
      output.writeFieldEnd();
  ...
  decode(input: thrift.TProtocol): IRestaurant {
      ...
      switch (fieldId) {
        ...
        case 4:
          if (fieldType === thrift.TType.STRUCT) {
            const value_4: com_gu_contententity_thrift.IAddress = com_gu_contententity_thrift.AddressCodec.decode(
              input
            );
        ...
        case 5:
          if (fieldType === thrift.TType.STRUCT) {
            const value_5: com_gu_contententity_thrift.IGeolocation = com_gu_contententity_thrift.GeolocationCodec.decode(
              input
            );
    ...
    if (_args.restaurantName !== undefined) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Restaurant from input'
      );
    }
  },
};
export class Restaurant extends thrift.StructLike implements IRestaurant {
  ...
  constructor(args: IRestaurantArgs) {
    ...
    if (args.address != null) {
      const value_9: com_gu_contententity_thrift.IAddress = new com_gu_contententity_thrift.Address(
        args.address
      );
      this.address = value_9;
    }
    if (args.geolocation != null) {
      const value_10: com_gu_contententity_thrift.IGeolocation = new com_gu_contententity_thrift.Geolocation(
        args.geolocation
      );
