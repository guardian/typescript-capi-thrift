...
export interface IGame {
  ...
  price?: com_gu_contententity_thrift.IPrice;
  pegiRating?: number;
  genre: Array<string>;
}
export interface IGameArgs {
  ...
  publisher?: string;
  platforms: Array<string>;
  price?: com_gu_contententity_thrift.IPriceArgs;
  pegiRating?: number;
  genre: Array<string>;
}
export const GameCodec: thrift.IStructCodec<IGameArgs, IGame> = {
  encode(args: IGameArgs, output: thrift.TProtocol): void {
    ...
    if (obj.platforms != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[platforms] is unset!'
      );
    }
    if (obj.price != null) {
      output.writeFieldBegin('price', thrift.TType.STRUCT, 4);
      com_gu_contententity_thrift.PriceCodec.encode(obj.price, output);
      output.writeFieldEnd();
    }
  ...
  decode(input: thrift.TProtocol): IGame {
      ...
      switch (fieldId) {
        ...
        case 4:
          if (fieldType === thrift.TType.STRUCT) {
            const value_7: com_gu_contententity_thrift.IPrice = com_gu_contententity_thrift.PriceCodec.decode(
              input
            );
            _args.price = value_7;
          } else {
    ...
    if (
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Game from input'
      );
    }
  },
};
export class Game extends thrift.StructLike implements IGame {
  ...
  public price?: com_gu_contententity_thrift.IPrice;
  ...
  constructor(args: IGameArgs) {
    ...
    if (args.price != null) {
      const value_14: com_gu_contententity_thrift.IPrice = new com_gu_contententity_thrift.Price(
        args.price
      );
      this.price = value_14;
    }
