            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_7: com_gu_contententity_thrift.IPrice = com_gu_contententity_thrift.PriceCodec.decode(input);
                        _args.price = value_7;
                    }
                    else {
                        input.skip(fieldType);
...
export class Game extends thrift.StructLike implements IGame {
    ...
    constructor(args: IGameArgs) {
        ...
        if (args.price != null) {
            const value_14: com_gu_contententity_thrift.IPrice = new com_gu_contententity_thrift.Price(args.price);
            this.price = value_14;
        }
