...
export interface IArticle {
  id: string;
  articleType: __NAMESPACE__.ArticleType;
...
export const ArticleCodec: thrift.IStructCodec<IArticleArgs, IArticle> = {
  encode(args: IArticleArgs, output: thrift.TProtocol): void {
    ...
    if (obj.articleType != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[articleType] is unset!'
      );
    }
    if (obj.group != null) {
  ...
  decode(input: thrift.TProtocol): IArticle {
      ...
      switch (fieldId) {
        ...
        case 2:
          if (fieldType === thrift.TType.I32) {
            const value_2: __NAMESPACE__.ArticleType = input.readI32();
        ...
        case 3:
          if (fieldType === thrift.TType.I32) {
            const value_3: __NAMESPACE__.Group = input.readI32();
            _args.group = value_3;
          } else {
            input.skip(fieldType);
          }
    ...
    if (
      _args.id !== undefined &&
      _args.articleType !== undefined &&
      _args.group !== undefined
    ) {
      return {
        id: _args.id,
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Article from input'
      );
    }
  },
};
export class Article extends thrift.StructLike implements IArticle {
  public id: string;
  public articleType: __NAMESPACE__.ArticleType;
  public group: __NAMESPACE__.Group;
  ...
  constructor(args: IArticleArgs) {
    ...
    if (args.articleType != null) {
      const value_18: __NAMESPACE__.ArticleType = args.articleType;
    ...
    if (args.group != null) {
      const value_19: __NAMESPACE__.Group = args.group;
      this.group = value_19;
    } else {
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
