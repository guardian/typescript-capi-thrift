...
export const StoryCodec: thrift.IStructCodec<IStoryArgs, IStory> = {
  encode(args: IStoryArgs, output: thrift.TProtocol): void {
    ...
    if (obj.summary != null) {
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Required field[summary] is unset!'
      );
    }
    if (obj.events != null) {
      ...
      obj.events.forEach(
        (value_1: __NAMESPACE__.IStoryEventArgs): void => {
  ...
  decode(input: thrift.TProtocol): IStory {
      ...
      switch (fieldId) {
        ...
        case 4:
          if (fieldType === thrift.TType.LIST) {
            const value_6: Array<__NAMESPACE__.IStoryEvent> = new Array<
              __NAMESPACE__.IStoryEvent
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_7: __NAMESPACE__.IStoryEvent = __NAMESPACE__.StoryEventCodec.decode(
                input
              );
        ...
        case 5:
          if (fieldType === thrift.TType.LIST) {
            const value_8: Array<com_gu_contentatom_thrift.IAtom> = new Array<
              com_gu_contentatom_thrift.IAtom
            >();
            const metadata_2: thrift.IThriftList = input.readListBegin();
            const size_2: number = metadata_2.size;
            for (let i_2: number = 0; i_2 < size_2; i_2++) {
              const value_9: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
                input
              );
    ...
    if (
      ...
      _args.summary !== undefined &&
      _args.events !== undefined &&
      _args.atoms !== undefined
    ) {
      return {
        id: _args.id,
        name: _args.name,
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read Story from input'
      );
    }
  },
};
export class Story extends thrift.StructLike implements IStory {
  ...
  constructor(args: IStoryArgs) {
    ...
    if (args.events != null) {
      const value_13: Array<__NAMESPACE__.IStoryEvent> = new Array<
        __NAMESPACE__.IStoryEvent
      >();
      args.events.forEach(
        (value_15: __NAMESPACE__.IStoryEventArgs): void => {
          const value_16: __NAMESPACE__.IStoryEvent = new __NAMESPACE__.StoryEvent(
            value_15
          );
    ...
    if (args.atoms != null) {
      const value_14: Array<com_gu_contentatom_thrift.IAtom> = new Array<
        com_gu_contentatom_thrift.IAtom
      >();
      args.atoms.forEach(
        (value_17: com_gu_contentatom_thrift.IAtomArgs): void => {
          const value_18: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(
            value_17
          );
