...
export const InteractiveElementFieldsCodec: thrift.IStructCodec<
  IInteractiveElementFieldsArgs,
  IInteractiveElementFields
> = {
...
export class InteractiveElementFields extends thrift.StructLike
  implements IInteractiveElementFields {
  public url?: string;
  ...
  public static read(input: thrift.TProtocol): InteractiveElementFields {
    return new InteractiveElementFields(
      InteractiveElementFieldsCodec.decode(input)
    );
  }
  public static write(
    args: IInteractiveElementFieldsArgs,
