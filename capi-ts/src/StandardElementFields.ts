...
export const StandardElementFieldsCodec: thrift.IStructCodec<
  IStandardElementFieldsArgs,
  IStandardElementFields
> = {
...
export class StandardElementFields extends thrift.StructLike
  implements IStandardElementFields {
  public url?: string;
  ...
  public static write(
    args: IStandardElementFieldsArgs,
