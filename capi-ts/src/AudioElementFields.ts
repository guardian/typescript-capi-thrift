...
export const AudioElementFieldsCodec: thrift.IStructCodec<
  IAudioElementFieldsArgs,
  IAudioElementFields
> = {
...
export class AudioElementFields extends thrift.StructLike
  implements IAudioElementFields {
  public html?: string;
