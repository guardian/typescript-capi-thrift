...
export interface IAtomsResponse {
    ...
    currentPage: number;
    pages: number;
    results: Array<com_gu_contentatom_thrift.IAtom>;
}
export interface IAtomsResponseArgs {
    ...
    currentPage: number;
    pages: number;
    results: Array<com_gu_contentatom_thrift.IAtomArgs>;
}
export const AtomsResponseCodec: thrift.IStructCodec<IAtomsResponseArgs, IAtomsResponse> = {
    encode(args: IAtomsResponseArgs, output: thrift.TProtocol): void {
        ...
        if (obj.results != null) {
            ...
            obj.results.forEach((value_1: com_gu_contentatom_thrift.IAtomArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 8:
                    if (fieldType === thrift.TType.LIST) {
                        const value_9: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_10: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(input);
...
export class AtomsResponse extends thrift.StructLike implements IAtomsResponse {
    ...
    public pages: number;
    public results: Array<com_gu_contentatom_thrift.IAtom>;
    ...
    constructor(args: IAtomsResponseArgs) {
        ...
        if (args.results != null) {
            const value_18: Array<com_gu_contentatom_thrift.IAtom> = new Array<com_gu_contentatom_thrift.IAtom>();
            args.results.forEach((value_19: com_gu_contentatom_thrift.IAtomArgs): void => {
                const value_20: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(value_19);
