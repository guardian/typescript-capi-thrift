...
export const AtomsResponseCodec: thrift.IStructCodec<
  IAtomsResponseArgs,
  IAtomsResponse
> = {
  ...
  decode(input: thrift.TProtocol): IAtomsResponse {
      ...
      switch (fieldId) {
        ...
        case 8:
          if (fieldType === thrift.TType.LIST) {
            const value_9: Array<com_gu_contentatom_thrift.IAtom> = new Array<
              com_gu_contentatom_thrift.IAtom
            >();
            const metadata_1: thrift.IThriftList = input.readListBegin();
            const size_1: number = metadata_1.size;
            for (let i_1: number = 0; i_1 < size_1; i_1++) {
              const value_10: com_gu_contentatom_thrift.IAtom = com_gu_contentatom_thrift.AtomCodec.decode(
                input
              );
    ...
    if (
      ...
      throw new thrift.TProtocolException(
        thrift.TProtocolExceptionType.UNKNOWN,
        'Unable to read AtomsResponse from input'
      );
    }
  },
};
export class AtomsResponse extends thrift.StructLike implements IAtomsResponse {
  ...
  constructor(args: IAtomsResponseArgs) {
    ...
    if (args.results != null) {
      const value_18: Array<com_gu_contentatom_thrift.IAtom> = new Array<
        com_gu_contentatom_thrift.IAtom
      >();
      args.results.forEach(
        (value_19: com_gu_contentatom_thrift.IAtomArgs): void => {
          const value_20: com_gu_contentatom_thrift.IAtom = new com_gu_contentatom_thrift.Atom(
            value_19
          );
