...
export interface ISponsorshipTargeting {
  publishedSince?: __NAMESPACE__.ICapiDateTime;
  validEditions?: Array<string>;
}
export interface ISponsorshipTargetingArgs {
  publishedSince?: __NAMESPACE__.ICapiDateTimeArgs;
  validEditions?: Array<string>;
}
export const SponsorshipTargetingCodec: thrift.IStructCodec<
  ISponsorshipTargetingArgs,
  ISponsorshipTargeting
> = {
  encode(args: ISponsorshipTargetingArgs, output: thrift.TProtocol): void {
    ...
    if (obj.publishedSince != null) {
      ...
      __NAMESPACE__.CapiDateTimeCodec.encode(obj.publishedSince, output);
...
export class SponsorshipTargeting extends thrift.StructLike
  implements ISponsorshipTargeting {
  public publishedSince?: __NAMESPACE__.ICapiDateTime;
  ...
  public static write(
    args: ISponsorshipTargetingArgs,
