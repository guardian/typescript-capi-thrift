...
export const BlockCodec: thrift.IStructCodec<IBlockArgs, IBlock> = {
    encode(args: IBlockArgs, output: thrift.TProtocol): void {
        ...
        if (obj.elements != null) {
            ...
            obj.elements.forEach((value_2: __NAMESPACE__.IBlockElementArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_7: __NAMESPACE__.IBlockAttributes = __NAMESPACE__.BlockAttributesCodec.decode(input);
                ...
                case 7:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_9: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
                ...
                case 12:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_15: __NAMESPACE__.IUser = __NAMESPACE__.UserCodec.decode(input);
                ...
                case 13:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_16: __NAMESPACE__.IUser = __NAMESPACE__.UserCodec.decode(input);
                ...
                case 14:
                    if (fieldType === thrift.TType.LIST) {
                        const value_17: Array<__NAMESPACE__.IBlockElement> = new Array<__NAMESPACE__.IBlockElement>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_18: __NAMESPACE__.IBlockElement = __NAMESPACE__.BlockElementCodec.decode(input);
...
export class Block extends thrift.StructLike implements IBlock {
    ...
    constructor(args: IBlockArgs) {
        ...
        if (args.attributes != null) {
            const value_23: __NAMESPACE__.IBlockAttributes = new __NAMESPACE__.BlockAttributes(args.attributes);
        ...
        if (args.createdDate != null) {
            const value_25: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.createdDate);
            this.createdDate = value_25;
        }
        if (args.firstPublishedDate != null) {
            const value_26: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.firstPublishedDate);
            this.firstPublishedDate = value_26;
        }
        if (args.publishedDate != null) {
            const value_27: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.publishedDate);
            this.publishedDate = value_27;
        }
        if (args.lastModifiedDate != null) {
            const value_28: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.lastModifiedDate);
        ...
        if (args.createdBy != null) {
            const value_30: __NAMESPACE__.IUser = new __NAMESPACE__.User(args.createdBy);
            this.createdBy = value_30;
        }
        if (args.lastModifiedBy != null) {
            const value_31: __NAMESPACE__.IUser = new __NAMESPACE__.User(args.lastModifiedBy);
            this.lastModifiedBy = value_31;
        }
        if (args.elements != null) {
            const value_32: Array<__NAMESPACE__.IBlockElement> = new Array<__NAMESPACE__.IBlockElement>();
            args.elements.forEach((value_35: __NAMESPACE__.IBlockElementArgs): void => {
                const value_36: __NAMESPACE__.IBlockElement = new __NAMESPACE__.BlockElement(value_35);
