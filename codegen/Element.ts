            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.TType.LIST) {
                        const value_6: Array<__NAMESPACE__.IAsset> = new Array<__NAMESPACE__.IAsset>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_7: __NAMESPACE__.IAsset = __NAMESPACE__.AssetCodec.decode(input);
...
export class Element extends thrift.StructLike implements IElement {
    ...
    constructor(args: IElementArgs) {
        ...
        if (args.assets != null) {
            const value_12: Array<__NAMESPACE__.IAsset> = new Array<__NAMESPACE__.IAsset>();
