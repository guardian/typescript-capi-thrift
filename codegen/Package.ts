...
export const PackageCodec: thrift.IStructCodec<IPackageArgs, IPackage> = {
    encode(args: IPackageArgs, output: thrift.TProtocol): void {
        ...
        if (obj.articles != null) {
            ...
            obj.articles.forEach((value_1: __NAMESPACE__.IPackageArticleArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.TType.LIST) {
                        const value_3: Array<__NAMESPACE__.IPackageArticle> = new Array<__NAMESPACE__.IPackageArticle>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_4: __NAMESPACE__.IPackageArticle = __NAMESPACE__.PackageArticleCodec.decode(input);
                ...
                case 4:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_6: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
...
export class Package extends thrift.StructLike implements IPackage {
    ...
    constructor(args: IPackageArgs) {
        ...
        if (args.articles != null) {
            const value_8: Array<__NAMESPACE__.IPackageArticle> = new Array<__NAMESPACE__.IPackageArticle>();
            args.articles.forEach((value_11: __NAMESPACE__.IPackageArticleArgs): void => {
                const value_12: __NAMESPACE__.IPackageArticle = new __NAMESPACE__.PackageArticle(value_11);
        ...
        if (args.lastModified != null) {
            const value_10: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.lastModified);
