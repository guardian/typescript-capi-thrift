...
export class MembershipElementFields extends thrift.StructLike implements IMembershipElementFields {
    ...
    constructor(args: IMembershipElementFieldsArgs = {}) {
        ...
        if (args.start != null) {
            const value_21: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.start);
            this.start = value_21;
        }
        if (args.end != null) {
            const value_22: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.end);
            this.end = value_22;
        }
    }
