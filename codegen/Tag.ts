...
export interface ITag {
    ...
    podcast?: __NAMESPACE__.IPodcast;
    firstName?: string;
    lastName?: string;
    emailAddress?: string;
    twitterHandle?: string;
    activeSponsorships?: Array<__NAMESPACE__.ISponsorship>;
...
export interface ITagArgs {
    ...
    bylineImageUrl?: string;
    bylineLargeImageUrl?: string;
    podcast?: __NAMESPACE__.IPodcastArgs;
    firstName?: string;
    lastName?: string;
    emailAddress?: string;
    twitterHandle?: string;
    activeSponsorships?: Array<__NAMESPACE__.ISponsorshipArgs>;
    paidContentType?: string;
    paidContentCampaignColour?: string;
    rcsId?: string;
    r2ContributorId?: string;
...
export const TagCodec: thrift.IStructCodec<ITagArgs, ITag> = {
    encode(args: ITagArgs, output: thrift.TProtocol): void {
        ...
        if (obj.references != null) {
            ...
            obj.references.forEach((value_1: __NAMESPACE__.IReferenceArgs): void => {
                __NAMESPACE__.ReferenceCodec.encode(value_1, output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
        ...
        if (obj.podcast != null) {
            ...
            __NAMESPACE__.PodcastCodec.encode(obj.podcast, output);
            output.writeFieldEnd();
        }
        ...
        if (obj.activeSponsorships != null) {
            ...
            obj.activeSponsorships.forEach((value_2: __NAMESPACE__.ISponsorshipArgs): void => {
                __NAMESPACE__.SponsorshipCodec.encode(value_2, output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.TType.I32) {
                        const value_6: __NAMESPACE__.TagType = input.readI32();
                        _args.type = value_6;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 8:
                    if (fieldType === thrift.TType.LIST) {
                        const value_12: Array<__NAMESPACE__.IReference> = new Array<__NAMESPACE__.IReference>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_13: __NAMESPACE__.IReference = __NAMESPACE__.ReferenceCodec.decode(input);
                ...
                case 13:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_18: __NAMESPACE__.IPodcast = __NAMESPACE__.PodcastCodec.decode(input);
                ...
                case 18:
                    if (fieldType === thrift.TType.LIST) {
                        const value_23: Array<__NAMESPACE__.ISponsorship> = new Array<__NAMESPACE__.ISponsorship>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_24: __NAMESPACE__.ISponsorship = __NAMESPACE__.SponsorshipCodec.decode(input);
...
export class Tag extends thrift.StructLike implements ITag {
    public id: string;
    public type: __NAMESPACE__.TagType;
    ...
    public podcast?: __NAMESPACE__.IPodcast;
    public firstName?: string;
    public lastName?: string;
    public emailAddress?: string;
    public twitterHandle?: string;
    public activeSponsorships?: Array<__NAMESPACE__.ISponsorship>;
    ...
    constructor(args: ITagArgs) {
        ...
        if (args.type != null) {
            const value_36: __NAMESPACE__.TagType = args.type;
            this.type = value_36;
        }
        else {
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Required field[type] is unset!");
        ...
        if (args.references != null) {
            ...
            args.references.forEach((value_61: __NAMESPACE__.IReferenceArgs): void => {
                const value_62: __NAMESPACE__.IReference = new __NAMESPACE__.Reference(value_61);
        ...
        if (args.podcast != null) {
            const value_47: __NAMESPACE__.IPodcast = new __NAMESPACE__.Podcast(args.podcast);
        ...
        if (args.activeSponsorships != null) {
            const value_52: Array<__NAMESPACE__.ISponsorship> = new Array<__NAMESPACE__.ISponsorship>();
            args.activeSponsorships.forEach((value_63: __NAMESPACE__.ISponsorshipArgs): void => {
                const value_64: __NAMESPACE__.ISponsorship = new __NAMESPACE__.Sponsorship(value_63);
