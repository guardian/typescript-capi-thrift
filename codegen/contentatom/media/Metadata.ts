            ...
            switch (fieldId) {
                ...
                case 8:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_10: __NAMESPACE__.IPlutoData = __NAMESPACE__.PlutoDataCodec.decode(input);
                ...
                case 9:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_11: __NAMESPACE__.IYoutubeData = __NAMESPACE__.YoutubeDataCodec.decode(input);
...
export class Metadata extends thrift.StructLike implements IMetadata {
    ...
    constructor(args: IMetadataArgs = {}) {
        ...
        if (args.pluto != null) {
            const value_19: __NAMESPACE__.IPlutoData = new __NAMESPACE__.PlutoData(args.pluto);
            this.pluto = value_19;
        }
        if (args.youtube != null) {
            const value_20: __NAMESPACE__.IYoutubeData = new __NAMESPACE__.YoutubeData(args.youtube);
