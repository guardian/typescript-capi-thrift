            ...
            switch (fieldId) {
                case 2:
                    if (fieldType === thrift.TType.LIST) {
                        const value_5: Array<__NAMESPACE__.IAsset> = new Array<__NAMESPACE__.IAsset>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_6: __NAMESPACE__.IAsset = __NAMESPACE__.AssetCodec.decode(input);
                ...
                case 11:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_15: __NAMESPACE__.IMetadata = __NAMESPACE__.MetadataCodec.decode(input);
                ...
                case 12:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_16: com_gu_contentatom_thrift.IImage = com_gu_contentatom_thrift.ImageCodec.decode(input);
                ...
                case 18:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_24: com_gu_contentatom_thrift.IImage = com_gu_contentatom_thrift.ImageCodec.decode(input);
...
export class MediaAtom extends thrift.StructLike implements IMediaAtom {
    ...
    constructor(args: IMediaAtomArgs) {
        super();
        if (args.assets != null) {
            const value_28: Array<__NAMESPACE__.IAsset> = new Array<__NAMESPACE__.IAsset>();
            args.assets.forEach((value_47: __NAMESPACE__.IAssetArgs): void => {
                const value_48: __NAMESPACE__.IAsset = new __NAMESPACE__.Asset(value_47);
        ...
        if (args.metadata != null) {
            const value_37: __NAMESPACE__.IMetadata = new __NAMESPACE__.Metadata(args.metadata);
            this.metadata = value_37;
        }
        if (args.posterImage != null) {
            const value_38: com_gu_contentatom_thrift.IImage = new com_gu_contentatom_thrift.Image(args.posterImage);
        ...
        if (args.trailImage != null) {
            const value_43: com_gu_contentatom_thrift.IImage = new com_gu_contentatom_thrift.Image(args.trailImage);
