...
export const TimelineAtomCodec: thrift.IStructCodec<ITimelineAtomArgs, ITimelineAtom> = {
    encode(args: ITimelineAtomArgs, output: thrift.TProtocol): void {
        ...
        if (obj.events != null) {
            ...
            obj.events.forEach((value_1: __NAMESPACE__.ITimelineItemArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.TType.LIST) {
                        const value_3: Array<__NAMESPACE__.ITimelineItem> = new Array<__NAMESPACE__.ITimelineItem>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_4: __NAMESPACE__.ITimelineItem = __NAMESPACE__.TimelineItemCodec.decode(input);
...
export class TimelineAtom extends thrift.StructLike implements ITimelineAtom {
    ...
    constructor(args: ITimelineAtomArgs) {
        ...
        if (args.events != null) {
            const value_7: Array<__NAMESPACE__.ITimelineItem> = new Array<__NAMESPACE__.ITimelineItem>();
            args.events.forEach((value_9: __NAMESPACE__.ITimelineItemArgs): void => {
                const value_10: __NAMESPACE__.ITimelineItem = new __NAMESPACE__.TimelineItem(value_9);
