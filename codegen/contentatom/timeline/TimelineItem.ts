...
export class TimelineItem extends thrift.StructLike implements ITimelineItem {
    ...
    constructor(args: ITimelineItemArgs) {
        ...
        if (args.entities != null) {
            const value_10: Array<com_gu_contententity_thrift.IEntity> = new Array<com_gu_contententity_thrift.IEntity>();
            args.entities.forEach((value_13: com_gu_contententity_thrift.IEntityArgs): void => {
                const value_14: com_gu_contententity_thrift.IEntity = new com_gu_contententity_thrift.Entity(value_13);
        ...
        if (args.toDate != null) {
            const value_12: thrift.Int64 = (typeof args.toDate === "number" ? new thrift.Int64(args.toDate) : typeof args.toDate === "string" ? thrift.Int64.fromDecimalString(args.toDate) : args.toDate);
