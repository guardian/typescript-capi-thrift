...
export const ProfileAtomCodec: thrift.IStructCodec<IProfileAtomArgs, IProfileAtom> = {
    encode(args: IProfileAtomArgs, output: thrift.TProtocol): void {
        ...
        if (obj.items != null) {
            ...
            obj.items.forEach((value_1: __NAMESPACE__.IProfileItemArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_3: com_gu_contentatom_thrift.IImage = com_gu_contentatom_thrift.ImageCodec.decode(input);
                ...
                case 4:
                    if (fieldType === thrift.TType.LIST) {
                        const value_4: Array<__NAMESPACE__.IProfileItem> = new Array<__NAMESPACE__.IProfileItem>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_5: __NAMESPACE__.IProfileItem = __NAMESPACE__.ProfileItemCodec.decode(input);
...
export class ProfileAtom extends thrift.StructLike implements IProfileAtom {
    ...
    constructor(args: IProfileAtomArgs) {
        ...
        if (args.headshot != null) {
            const value_8: com_gu_contentatom_thrift.IImage = new com_gu_contentatom_thrift.Image(args.headshot);
            this.headshot = value_8;
        }
        if (args.items != null) {
            const value_9: Array<__NAMESPACE__.IProfileItem> = new Array<__NAMESPACE__.IProfileItem>();
            args.items.forEach((value_11: __NAMESPACE__.IProfileItemArgs): void => {
                const value_12: __NAMESPACE__.IProfileItem = new __NAMESPACE__.ProfileItem(value_11);
        ...
        if (args.entity != null) {
            const value_10: com_gu_contententity_thrift.IEntity = new com_gu_contententity_thrift.Entity(args.entity);
