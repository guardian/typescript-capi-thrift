...
export const ResultBucketsCodec: thrift.IStructCodec<IResultBucketsArgs, IResultBuckets> = {
    encode(args: IResultBucketsArgs, output: thrift.TProtocol): void {
        ...
        if (obj.buckets != null) {
            ...
            obj.buckets.forEach((value_1: __NAMESPACE__.IResultBucketArgs): void => {
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.LIST) {
                        const value_2: Array<__NAMESPACE__.IResultBucket> = new Array<__NAMESPACE__.IResultBucket>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_3: __NAMESPACE__.IResultBucket = __NAMESPACE__.ResultBucketCodec.decode(input);
...
export class ResultBuckets extends thrift.StructLike implements IResultBuckets {
    ...
    constructor(args: IResultBucketsArgs) {
        ...
        if (args.buckets != null) {
            const value_4: Array<__NAMESPACE__.IResultBucket> = new Array<__NAMESPACE__.IResultBucket>();
            args.buckets.forEach((value_5: __NAMESPACE__.IResultBucketArgs): void => {
                const value_6: __NAMESPACE__.IResultBucket = new __NAMESPACE__.ResultBucket(value_5);
