            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.LIST) {
                        const value_2: Array<__NAMESPACE__.IAsset> = new Array<__NAMESPACE__.IAsset>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_3: __NAMESPACE__.IAsset = __NAMESPACE__.AssetCodec.decode(input);
...
export class ResultBucket extends thrift.StructLike implements IResultBucket {
    ...
    constructor(args: IResultBucketArgs) {
        super();
        if (args.assets != null) {
            const value_8: Array<__NAMESPACE__.IAsset> = new Array<__NAMESPACE__.IAsset>();
