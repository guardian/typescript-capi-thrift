...
export const ResultGroupsCodec: thrift.IStructCodec<IResultGroupsArgs, IResultGroups> = {
    encode(args: IResultGroupsArgs, output: thrift.TProtocol): void {
        ...
        if (obj.groups != null) {
            ...
            obj.groups.forEach((value_1: __NAMESPACE__.IResultGroupArgs): void => {
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.LIST) {
                        const value_2: Array<__NAMESPACE__.IResultGroup> = new Array<__NAMESPACE__.IResultGroup>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_3: __NAMESPACE__.IResultGroup = __NAMESPACE__.ResultGroupCodec.decode(input);
...
export class ResultGroups extends thrift.StructLike implements IResultGroups {
    ...
    constructor(args: IResultGroupsArgs) {
        super();
        if (args.groups != null) {
            const value_4: Array<__NAMESPACE__.IResultGroup> = new Array<__NAMESPACE__.IResultGroup>();
            args.groups.forEach((value_5: __NAMESPACE__.IResultGroupArgs): void => {
                const value_6: __NAMESPACE__.IResultGroup = new __NAMESPACE__.ResultGroup(value_5);
