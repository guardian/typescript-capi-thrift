            ...
            switch (fieldId) {
                ...
                case 10:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_7: __NAMESPACE__.IQuizContent = __NAMESPACE__.QuizContentCodec.decode(input);
...
export class QuizAtom extends thrift.StructLike implements IQuizAtom {
    ...
    constructor(args: IQuizAtomArgs) {
        ...
        if (args.content != null) {
            const value_14: __NAMESPACE__.IQuizContent = new __NAMESPACE__.QuizContent(args.content);
