            ...
            switch (fieldId) {
                ...
                case 6:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_6: __NAMESPACE__.IOffPlatform = __NAMESPACE__.OffPlatformCodec.decode(input);
...
export class AudioAtom extends thrift.StructLike implements IAudioAtom {
    ...
    constructor(args: IAudioAtomArgs) {
        ...
        if (args.offPlatformLinks != null) {
            const value_12: __NAMESPACE__.IOffPlatform = new __NAMESPACE__.OffPlatform(args.offPlatformLinks);
