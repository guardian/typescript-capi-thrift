            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.TType.LIST) {
                        const value_4: Array<__NAMESPACE__.IQuestion> = new Array<__NAMESPACE__.IQuestion>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_5: __NAMESPACE__.IQuestion = __NAMESPACE__.QuestionCodec.decode(input);
...
export class QuestionSet extends thrift.StructLike implements IQuestionSet {
    ...
    constructor(args: IQuestionSetArgs) {
        ...
        if (args.questions != null) {
            const value_8: Array<__NAMESPACE__.IQuestion> = new Array<__NAMESPACE__.IQuestion>();
