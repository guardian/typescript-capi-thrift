...
export const GuideAtomCodec: thrift.IStructCodec<IGuideAtomArgs, IGuideAtom> = {
    encode(args: IGuideAtomArgs, output: thrift.TProtocol): void {
        ...
        if (obj.items != null) {
            ...
            obj.items.forEach((value_1: __NAMESPACE__.IGuideItemArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.TType.LIST) {
                        const value_4: Array<__NAMESPACE__.IGuideItem> = new Array<__NAMESPACE__.IGuideItem>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_5: __NAMESPACE__.IGuideItem = __NAMESPACE__.GuideItemCodec.decode(input);
...
export class GuideAtom extends thrift.StructLike implements IGuideAtom {
    ...
    constructor(args: IGuideAtomArgs) {
        ...
        if (args.guideImage != null) {
            const value_7: com_gu_contentatom_thrift.IImage = new com_gu_contentatom_thrift.Image(args.guideImage);
            this.guideImage = value_7;
        }
        if (args.items != null) {
            const value_8: Array<__NAMESPACE__.IGuideItem> = new Array<__NAMESPACE__.IGuideItem>();
            args.items.forEach((value_9: __NAMESPACE__.IGuideItemArgs): void => {
                const value_10: __NAMESPACE__.IGuideItem = new __NAMESPACE__.GuideItem(value_9);
