...
export const RecipeAtomCodec: thrift.IStructCodec<IRecipeAtomArgs, IRecipeAtom> = {
    encode(args: IRecipeAtomArgs, output: thrift.TProtocol): void {
        ...
        if (obj.ingredientsLists != null) {
            ...
            obj.ingredientsLists.forEach((value_1: __NAMESPACE__.IIngredientsListArgs): void => {
        ...
        if (obj.images != null) {
            ...
            obj.images.forEach((value_4: com_gu_contentatom_thrift.IImageArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_6: __NAMESPACE__.ITags = __NAMESPACE__.TagsCodec.decode(input);
                        _args.tags = value_6;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 3:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_7: __NAMESPACE__.ITime = __NAMESPACE__.TimeCodec.decode(input);
                        _args.time = value_7;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 4:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_8: __NAMESPACE__.IServes = __NAMESPACE__.ServesCodec.decode(input);
                ...
                case 5:
                    if (fieldType === thrift.TType.LIST) {
                        const value_9: Array<__NAMESPACE__.IIngredientsList> = new Array<__NAMESPACE__.IIngredientsList>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_10: __NAMESPACE__.IIngredientsList = __NAMESPACE__.IngredientsListCodec.decode(input);
                ...
                case 8:
                    if (fieldType === thrift.TType.LIST) {
                        const value_15: Array<com_gu_contentatom_thrift.IImage> = new Array<com_gu_contentatom_thrift.IImage>();
...
export class RecipeAtom extends thrift.StructLike implements IRecipeAtom {
    ...
    constructor(args: IRecipeAtomArgs) {
        ...
        if (args.serves != null) {
            const value_21: __NAMESPACE__.IServes = new __NAMESPACE__.Serves(args.serves);
            this.serves = value_21;
        }
        if (args.ingredientsLists != null) {
            const value_22: Array<__NAMESPACE__.IIngredientsList> = new Array<__NAMESPACE__.IIngredientsList>();
            args.ingredientsLists.forEach((value_27: __NAMESPACE__.IIngredientsListArgs): void => {
                const value_28: __NAMESPACE__.IIngredientsList = new __NAMESPACE__.IngredientsList(value_27);
        ...
        if (args.images != null) {
            const value_25: Array<com_gu_contentatom_thrift.IImage> = new Array<com_gu_contentatom_thrift.IImage>();
            args.images.forEach((value_33: com_gu_contentatom_thrift.IImageArgs): void => {
                const value_34: com_gu_contentatom_thrift.IImage = new com_gu_contentatom_thrift.Image(value_33);
