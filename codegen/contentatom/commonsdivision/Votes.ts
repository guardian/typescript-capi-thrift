...
export const VotesCodec: thrift.IStructCodec<IVotesArgs, IVotes> = {
    encode(args: IVotesArgs, output: thrift.TProtocol): void {
        ...
        if (obj.ayes != null) {
            ...
            obj.ayes.forEach((value_1: __NAMESPACE__.IMPArgs): void => {
        ...
        if (obj.noes != null) {
            ...
            obj.noes.forEach((value_2: __NAMESPACE__.IMPArgs): void => {
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.LIST) {
                        const value_3: Array<__NAMESPACE__.IMP> = new Array<__NAMESPACE__.IMP>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_4: __NAMESPACE__.IMP = __NAMESPACE__.MPCodec.decode(input);
                ...
                case 2:
                    if (fieldType === thrift.TType.LIST) {
                        const value_5: Array<__NAMESPACE__.IMP> = new Array<__NAMESPACE__.IMP>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_6: __NAMESPACE__.IMP = __NAMESPACE__.MPCodec.decode(input);
...
export class Votes extends thrift.StructLike implements IVotes {
    ...
    constructor(args: IVotesArgs) {
        ...
        if (args.ayes != null) {
            ...
            args.ayes.forEach((value_9: __NAMESPACE__.IMPArgs): void => {
        ...
        if (args.noes != null) {
            ...
            args.noes.forEach((value_11: __NAMESPACE__.IMPArgs): void => {
