...
import * as com_gu_contententity_thrift_entity_restaurant from "./../../com/gu/contententity/thrift/entity/restaurant";
import * as com_gu_contententity_thrift_entity_game from "./../../com/gu/contententity/thrift/entity/game";
import * as com_gu_contententity_thrift_entity_film from "./../../com/gu/contententity/thrift/entity/film";
import * as com_gu_contentatom_thrift from "./../../com/gu/contentatom/thrift";
import * as __NAMESPACE__ from "./.";
export interface IReviewAtom {
    reviewType: __NAMESPACE__.ReviewType;
    reviewer: string;
    rating: __NAMESPACE__.IRating;
...
export interface IReviewAtomArgs {
    reviewType: __NAMESPACE__.ReviewType;
    reviewer: string;
    rating: __NAMESPACE__.IRatingArgs;
    reviewSnippet: string;
    entityId: string;
...
export const ReviewAtomCodec: thrift.IStructCodec<IReviewAtomArgs, IReviewAtom> = {
    encode(args: IReviewAtomArgs, output: thrift.TProtocol): void {
        ...
        if (obj.rating != null) {
            ...
            __NAMESPACE__.RatingCodec.encode(obj.rating, output);
            output.writeFieldEnd();
        }
        else {
        ...
        if (obj.restaurant != null) {
            ...
            com_gu_contententity_thrift_entity_restaurant.RestaurantCodec.encode(obj.restaurant, output);
            output.writeFieldEnd();
        }
        if (obj.game != null) {
            output.writeFieldBegin("game", thrift.TType.STRUCT, 7);
            com_gu_contententity_thrift_entity_game.GameCodec.encode(obj.game, output);
            output.writeFieldEnd();
        }
        if (obj.film != null) {
            output.writeFieldBegin("film", thrift.TType.STRUCT, 8);
            com_gu_contententity_thrift_entity_film.FilmCodec.encode(obj.film, output);
            output.writeFieldEnd();
        }
        ...
        if (obj.images != null) {
            ...
            obj.images.forEach((value_1: com_gu_contentatom_thrift.IImageArgs): void => {
                com_gu_contentatom_thrift.ImageCodec.encode(value_1, output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.I32) {
                        const value_2: __NAMESPACE__.ReviewType = input.readI32();
                ...
                case 3:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_4: __NAMESPACE__.IRating = __NAMESPACE__.RatingCodec.decode(input);
                ...
                case 6:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_7: com_gu_contententity_thrift_entity_restaurant.IRestaurant = com_gu_contententity_thrift_entity_restaurant.RestaurantCodec.decode(input);
                ...
                case 7:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_8: com_gu_contententity_thrift_entity_game.IGame = com_gu_contententity_thrift_entity_game.GameCodec.decode(input);
                        _args.game = value_8;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 8:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_9: com_gu_contententity_thrift_entity_film.IFilm = com_gu_contententity_thrift_entity_film.FilmCodec.decode(input);
                        _args.film = value_9;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 10:
                    if (fieldType === thrift.TType.LIST) {
                        const value_11: Array<com_gu_contentatom_thrift.IImage> = new Array<com_gu_contentatom_thrift.IImage>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_12: com_gu_contentatom_thrift.IImage = com_gu_contentatom_thrift.ImageCodec.decode(input);
...
export class ReviewAtom extends thrift.StructLike implements IReviewAtom {
    public reviewType: __NAMESPACE__.ReviewType;
    public reviewer: string;
    public rating: __NAMESPACE__.IRating;
    ...
    constructor(args: IReviewAtomArgs) {
        ...
        if (args.reviewType != null) {
            const value_13: __NAMESPACE__.ReviewType = args.reviewType;
        ...
        if (args.rating != null) {
            const value_15: __NAMESPACE__.IRating = new __NAMESPACE__.Rating(args.rating);
        ...
        if (args.restaurant != null) {
            const value_18: com_gu_contententity_thrift_entity_restaurant.IRestaurant = new com_gu_contententity_thrift_entity_restaurant.Restaurant(args.restaurant);
            this.restaurant = value_18;
        }
        if (args.game != null) {
            const value_19: com_gu_contententity_thrift_entity_game.IGame = new com_gu_contententity_thrift_entity_game.Game(args.game);
            this.game = value_19;
        }
        if (args.film != null) {
            const value_20: com_gu_contententity_thrift_entity_film.IFilm = new com_gu_contententity_thrift_entity_film.Film(args.film);
            this.film = value_20;
        }
        ...
        if (args.images != null) {
            const value_22: Array<com_gu_contentatom_thrift.IImage> = new Array<com_gu_contentatom_thrift.IImage>();
            args.images.forEach((value_23: com_gu_contentatom_thrift.IImageArgs): void => {
                const value_24: com_gu_contentatom_thrift.IImage = new com_gu_contentatom_thrift.Image(value_23);
