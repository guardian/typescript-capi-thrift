...
export const ContentCodec: thrift.IStructCodec<IContentArgs, IContent> = {
    encode(args: IContentArgs, output: thrift.TProtocol): void {
        ...
        if (obj.tags != null) {
            ...
            obj.tags.forEach((value_1: __NAMESPACE__.ITagArgs): void => {
        ...
        if (obj.elements != null) {
            ...
            obj.elements.forEach((value_2: __NAMESPACE__.IElementArgs): void => {
        ...
        if (obj.references != null) {
            ...
            obj.references.forEach((value_3: __NAMESPACE__.IReferenceArgs): void => {
    ...
    decode(input: thrift.TProtocol): IContent {
            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_8: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
                ...
                case 9:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_12: __NAMESPACE__.IContentFields = __NAMESPACE__.ContentFieldsCodec.decode(input);
                ...
                case 10:
                    if (fieldType === thrift.TType.LIST) {
                        const value_13: Array<__NAMESPACE__.ITag> = new Array<__NAMESPACE__.ITag>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_14: __NAMESPACE__.ITag = __NAMESPACE__.TagCodec.decode(input);
                ...
                case 11:
                    if (fieldType === thrift.TType.LIST) {
                        const value_15: Array<__NAMESPACE__.IElement> = new Array<__NAMESPACE__.IElement>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_16: __NAMESPACE__.IElement = __NAMESPACE__.ElementCodec.decode(input);
                ...
                case 12:
                    if (fieldType === thrift.TType.LIST) {
                        const value_17: Array<__NAMESPACE__.IReference> = new Array<__NAMESPACE__.IReference>();
                        const metadata_3: thrift.IThriftList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_18: __NAMESPACE__.IReference = __NAMESPACE__.ReferenceCodec.decode(input);
                ...
                case 14:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_20: __NAMESPACE__.IBlocks = __NAMESPACE__.BlocksCodec.decode(input);
                ...
                case 15:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_21: __NAMESPACE__.IRights = __NAMESPACE__.RightsCodec.decode(input);
                ...
                case 16:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_22: __NAMESPACE__.ICrossword = __NAMESPACE__.CrosswordCodec.decode(input);
                ...
                case 17:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_23: __NAMESPACE__.IAtoms = __NAMESPACE__.AtomsCodec.decode(input);
                ...
                case 18:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_24: __NAMESPACE__.IContentStats = __NAMESPACE__.ContentStatsCodec.decode(input);
                ...
                case 19:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_25: __NAMESPACE__.ISection = __NAMESPACE__.SectionCodec.decode(input);
                ...
                case 20:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_26: __NAMESPACE__.IDebug = __NAMESPACE__.DebugCodec.decode(input);
        ...
        if (_args.id !== undefined && _args.type !== undefined && _args.webTitle !== undefined && _args.webUrl !== undefined && _args.apiUrl !== undefined && _args.tags !== undefined && _args.references !== undefined && _args.isHosted !== undefined) {
            return {
                id: _args.id,
                type: (_args.type != null ? _args.type : __NAMESPACE__.ContentType.ARTICLE),
...
export class Content extends thrift.StructLike implements IContent {
    ...
    constructor(args: IContentArgs) {
        ...
        if (args.webPublicationDate != null) {
            const value_35: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.webPublicationDate);
        ...
        if (args.fields != null) {
            const value_39: __NAMESPACE__.IContentFields = new __NAMESPACE__.ContentFields(args.fields);
            this.fields = value_39;
        }
        if (args.tags != null) {
            const value_40: Array<__NAMESPACE__.ITag> = new Array<__NAMESPACE__.ITag>();
            args.tags.forEach((value_55: __NAMESPACE__.ITagArgs): void => {
        ...
        if (args.elements != null) {
            const value_41: Array<__NAMESPACE__.IElement> = new Array<__NAMESPACE__.IElement>();
            args.elements.forEach((value_57: __NAMESPACE__.IElementArgs): void => {
                const value_58: __NAMESPACE__.IElement = new __NAMESPACE__.Element(value_57);
                value_41.push(value_58);
            });
            this.elements = value_41;
        }
        if (args.references != null) {
            const value_42: Array<__NAMESPACE__.IReference> = new Array<__NAMESPACE__.IReference>();
            args.references.forEach((value_59: __NAMESPACE__.IReferenceArgs): void => {
                const value_60: __NAMESPACE__.IReference = new __NAMESPACE__.Reference(value_59);
        ...
        if (args.blocks != null) {
            const value_44: __NAMESPACE__.IBlocks = new __NAMESPACE__.Blocks(args.blocks);
            this.blocks = value_44;
        }
        if (args.rights != null) {
            const value_45: __NAMESPACE__.IRights = new __NAMESPACE__.Rights(args.rights);
            this.rights = value_45;
        }
        if (args.crossword != null) {
            const value_46: __NAMESPACE__.ICrossword = new __NAMESPACE__.Crossword(args.crossword);
            this.crossword = value_46;
        }
        if (args.atoms != null) {
            const value_47: __NAMESPACE__.IAtoms = new __NAMESPACE__.Atoms(args.atoms);
            this.atoms = value_47;
        }
        if (args.stats != null) {
            const value_48: __NAMESPACE__.IContentStats = new __NAMESPACE__.ContentStats(args.stats);
            this.stats = value_48;
        }
        if (args.section != null) {
            const value_49: __NAMESPACE__.ISection = new __NAMESPACE__.Section(args.section);
            this.section = value_49;
        }
        if (args.debug != null) {
            const value_50: __NAMESPACE__.IDebug = new __NAMESPACE__.Debug(args.debug);
            this.debug = value_50;
        }
        if (args.isGone != null) {
