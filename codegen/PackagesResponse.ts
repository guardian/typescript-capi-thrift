...
export const PackagesResponseCodec: thrift.IStructCodec<IPackagesResponseArgs, IPackagesResponse> = {
    encode(args: IPackagesResponseArgs, output: thrift.TProtocol): void {
        ...
        if (obj.results != null) {
            ...
            obj.results.forEach((value_1: __NAMESPACE__.IPackageArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 9:
                    if (fieldType === thrift.TType.LIST) {
                        const value_10: Array<__NAMESPACE__.IPackage> = new Array<__NAMESPACE__.IPackage>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_11: __NAMESPACE__.IPackage = __NAMESPACE__.PackageCodec.decode(input);
...
export class PackagesResponse extends thrift.StructLike implements IPackagesResponse {
    ...
    constructor(args: IPackagesResponseArgs) {
        ...
        if (args.results != null) {
            const value_20: Array<__NAMESPACE__.IPackage> = new Array<__NAMESPACE__.IPackage>();
            args.results.forEach((value_21: __NAMESPACE__.IPackageArgs): void => {
                const value_22: __NAMESPACE__.IPackage = new __NAMESPACE__.Package(value_21);
