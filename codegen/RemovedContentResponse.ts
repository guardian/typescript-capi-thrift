...
export const RemovedContentResponseCodec: thrift.IStructCodec<IRemovedContentResponseArgs, IRemovedContentResponse> = {
    encode(args: IRemovedContentResponseArgs, output: thrift.TProtocol): void {
        ...
        if (obj.resultsWithLastModified != null) {
            ...
            obj.resultsWithLastModified.forEach((value_2: __NAMESPACE__.IRemovedContentArgs): void => {
    ...
    decode(input: thrift.TProtocol): IRemovedContentResponse {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 10:
                    if (fieldType === thrift.TType.LIST) {
                        const value_13: Array<__NAMESPACE__.IRemovedContent> = new Array<__NAMESPACE__.IRemovedContent>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_14: __NAMESPACE__.IRemovedContent = __NAMESPACE__.RemovedContentCodec.decode(input);
...
export class RemovedContentResponse extends thrift.StructLike implements IRemovedContentResponse {
    ...
    constructor(args: IRemovedContentResponseArgs) {
        ...
        if (args.resultsWithLastModified != null) {
            const value_24: Array<__NAMESPACE__.IRemovedContent> = new Array<__NAMESPACE__.IRemovedContent>();
            args.resultsWithLastModified.forEach((value_27: __NAMESPACE__.IRemovedContentArgs): void => {
                const value_28: __NAMESPACE__.IRemovedContent = new __NAMESPACE__.RemovedContent(value_27);
