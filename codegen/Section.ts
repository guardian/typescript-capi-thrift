...
export interface ISection {
    ...
    webUrl: string;
    apiUrl: string;
    editions: Array<__NAMESPACE__.IEdition>;
...
export interface ISectionArgs {
    ...
    webUrl: string;
    apiUrl: string;
    editions: Array<__NAMESPACE__.IEditionArgs>;
...
export const SectionCodec: thrift.IStructCodec<ISectionArgs, ISection> = {
    encode(args: ISectionArgs, output: thrift.TProtocol): void {
        ...
        if (obj.editions != null) {
            ...
            obj.editions.forEach((value_1: __NAMESPACE__.IEditionArgs): void => {
                __NAMESPACE__.EditionCodec.encode(value_1, output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.TType.LIST) {
                        const value_7: Array<__NAMESPACE__.IEdition> = new Array<__NAMESPACE__.IEdition>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_8: __NAMESPACE__.IEdition = __NAMESPACE__.EditionCodec.decode(input);
                ...
                case 6:
                    if (fieldType === thrift.TType.LIST) {
                        const value_9: Array<__NAMESPACE__.ISponsorship> = new Array<__NAMESPACE__.ISponsorship>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_10: __NAMESPACE__.ISponsorship = __NAMESPACE__.SponsorshipCodec.decode(input);
...
export class Section extends thrift.StructLike implements ISection {
    ...
    public editions: Array<__NAMESPACE__.IEdition>;
    ...
    constructor(args: ISectionArgs) {
        ...
        if (args.editions != null) {
            const value_15: Array<__NAMESPACE__.IEdition> = new Array<__NAMESPACE__.IEdition>();
            args.editions.forEach((value_17: __NAMESPACE__.IEditionArgs): void => {
                const value_18: __NAMESPACE__.IEdition = new __NAMESPACE__.Edition(value_17);
        ...
        if (args.activeSponsorships != null) {
            const value_16: Array<__NAMESPACE__.ISponsorship> = new Array<__NAMESPACE__.ISponsorship>();
            args.activeSponsorships.forEach((value_19: __NAMESPACE__.ISponsorshipArgs): void => {
                const value_20: __NAMESPACE__.ISponsorship = new __NAMESPACE__.Sponsorship(value_19);
