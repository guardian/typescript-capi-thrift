...
export interface ITagsResponse {
    ...
    currentPage: number;
    pages: number;
    results: Array<__NAMESPACE__.ITag>;
}
export interface ITagsResponseArgs {
    ...
    currentPage: number;
    pages: number;
    results: Array<__NAMESPACE__.ITagArgs>;
}
export const TagsResponseCodec: thrift.IStructCodec<ITagsResponseArgs, ITagsResponse> = {
    encode(args: ITagsResponseArgs, output: thrift.TProtocol): void {
        ...
        if (obj.results != null) {
            ...
            obj.results.forEach((value_1: __NAMESPACE__.ITagArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 8:
                    if (fieldType === thrift.TType.LIST) {
                        const value_9: Array<__NAMESPACE__.ITag> = new Array<__NAMESPACE__.ITag>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_10: __NAMESPACE__.ITag = __NAMESPACE__.TagCodec.decode(input);
...
export class TagsResponse extends thrift.StructLike implements ITagsResponse {
    ...
    public pages: number;
    public results: Array<__NAMESPACE__.ITag>;
    ...
    constructor(args: ITagsResponseArgs) {
        ...
        if (args.results != null) {
            const value_18: Array<__NAMESPACE__.ITag> = new Array<__NAMESPACE__.ITag>();
            args.results.forEach((value_19: __NAMESPACE__.ITagArgs): void => {
