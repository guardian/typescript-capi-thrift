...
export const RemovedContentCodec: thrift.IStructCodec<IRemovedContentArgs, IRemovedContent> = {
    ...
    decode(input: thrift.TProtocol): IRemovedContent {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_2: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
        ...
        if (_args.id !== undefined && _args.lastModified !== undefined) {
            ...
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Unable to read RemovedContent from input");
        }
    }
};
export class RemovedContent extends thrift.StructLike implements IRemovedContent {
    public id: string;
    ...
    constructor(args: IRemovedContentArgs) {
        ...
        if (args.lastModified != null) {
            const value_4: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.lastModified);
    ...
    public static write(args: IRemovedContentArgs, output: thrift.TProtocol): void {
