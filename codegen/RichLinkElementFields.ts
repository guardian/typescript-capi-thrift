            ...
            switch (fieldId) {
                ...
                case 6:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_6: __NAMESPACE__.ISponsorship = __NAMESPACE__.SponsorshipCodec.decode(input);
...
export class RichLinkElementFields extends thrift.StructLike implements IRichLinkElementFields {
    ...
    constructor(args: IRichLinkElementFieldsArgs = {}) {
        ...
        if (args.sponsorship != null) {
            const value_12: __NAMESPACE__.ISponsorship = new __NAMESPACE__.Sponsorship(args.sponsorship);
