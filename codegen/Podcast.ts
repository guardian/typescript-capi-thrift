...
export const PodcastCodec: thrift.IStructCodec<IPodcastArgs, IPodcast> = {
    encode(args: IPodcastArgs, output: thrift.TProtocol): void {
        ...
        if (obj.categories != null) {
            ...
            obj.categories.forEach((value_1: __NAMESPACE__.IPodcastCategoryArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 7:
                    if (fieldType === thrift.TType.LIST) {
                        const value_8: Array<__NAMESPACE__.IPodcastCategory> = new Array<__NAMESPACE__.IPodcastCategory>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_9: __NAMESPACE__.IPodcastCategory = __NAMESPACE__.PodcastCategoryCodec.decode(input);
...
export class Podcast extends thrift.StructLike implements IPodcast {
    ...
    constructor(args: IPodcastArgs) {
        ...
        if (args.categories != null) {
            const value_19: Array<__NAMESPACE__.IPodcastCategory> = new Array<__NAMESPACE__.IPodcastCategory>();
            args.categories.forEach((value_23: __NAMESPACE__.IPodcastCategoryArgs): void => {
                const value_24: __NAMESPACE__.IPodcastCategory = new __NAMESPACE__.PodcastCategory(value_23);
