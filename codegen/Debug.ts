            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_1: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
...
export class Debug extends thrift.StructLike implements IDebug {
    ...
    constructor(args: IDebugArgs = {}) {
        ...
        if (args.lastSeenByPorterAt != null) {
            const value_5: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.lastSeenByPorterAt);
