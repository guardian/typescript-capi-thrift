...
import * as com_gu_contententity_thrift_entity_person from "./../person";
export interface IFilm {
    title: string;
    year: number;
    imdbId: string;
    directors: Array<com_gu_contententity_thrift_entity_person.IPerson>;
    actors: Array<com_gu_contententity_thrift_entity_person.IPerson>;
    genre: Array<string>;
}
export interface IFilmArgs {
    ...
    year: number;
    imdbId: string;
    directors: Array<com_gu_contententity_thrift_entity_person.IPersonArgs>;
    actors: Array<com_gu_contententity_thrift_entity_person.IPersonArgs>;
    genre: Array<string>;
}
export const FilmCodec: thrift.IStructCodec<IFilmArgs, IFilm> = {
    encode(args: IFilmArgs, output: thrift.TProtocol): void {
        ...
        if (obj.directors != null) {
            ...
            obj.directors.forEach((value_1: com_gu_contententity_thrift_entity_person.IPersonArgs): void => {
                com_gu_contententity_thrift_entity_person.PersonCodec.encode(value_1, output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
        ...
        if (obj.actors != null) {
            ...
            obj.actors.forEach((value_2: com_gu_contententity_thrift_entity_person.IPersonArgs): void => {
                com_gu_contententity_thrift_entity_person.PersonCodec.encode(value_2, output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.TType.LIST) {
                        const value_7: Array<com_gu_contententity_thrift_entity_person.IPerson> = new Array<com_gu_contententity_thrift_entity_person.IPerson>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_8: com_gu_contententity_thrift_entity_person.IPerson = com_gu_contententity_thrift_entity_person.PersonCodec.decode(input);
                ...
                case 5:
                    if (fieldType === thrift.TType.LIST) {
                        const value_9: Array<com_gu_contententity_thrift_entity_person.IPerson> = new Array<com_gu_contententity_thrift_entity_person.IPerson>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_10: com_gu_contententity_thrift_entity_person.IPerson = com_gu_contententity_thrift_entity_person.PersonCodec.decode(input);
...
export class Film extends thrift.StructLike implements IFilm {
    ...
    public directors: Array<com_gu_contententity_thrift_entity_person.IPerson>;
    public actors: Array<com_gu_contententity_thrift_entity_person.IPerson>;
    ...
    constructor(args: IFilmArgs) {
        ...
        if (args.directors != null) {
            const value_16: Array<com_gu_contententity_thrift_entity_person.IPerson> = new Array<com_gu_contententity_thrift_entity_person.IPerson>();
            args.directors.forEach((value_19: com_gu_contententity_thrift_entity_person.IPersonArgs): void => {
                const value_20: com_gu_contententity_thrift_entity_person.IPerson = new com_gu_contententity_thrift_entity_person.Person(value_19);
        ...
        if (args.actors != null) {
            const value_17: Array<com_gu_contententity_thrift_entity_person.IPerson> = new Array<com_gu_contententity_thrift_entity_person.IPerson>();
            args.actors.forEach((value_21: com_gu_contententity_thrift_entity_person.IPersonArgs): void => {
                const value_22: com_gu_contententity_thrift_entity_person.IPerson = new com_gu_contententity_thrift_entity_person.Person(value_21);
