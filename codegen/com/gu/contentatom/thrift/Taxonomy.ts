...
export const TaxonomyCodec: thrift.IStructCodec<ITaxonomyArgs, ITaxonomy> = {
    encode(args: ITaxonomyArgs, output: thrift.TProtocol): void {
        ...
        if (obj.tags != null) {
            ...
            obj.tags.forEach((value_1: __NAMESPACE__.ITagUsageArgs): void => {
        ...
        if (obj.contributors != null) {
            ...
            obj.contributors.forEach((value_2: __NAMESPACE__.ITagArgs): void => {
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.LIST) {
                        const value_4: Array<__NAMESPACE__.ITagUsage> = new Array<__NAMESPACE__.ITagUsage>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_5: __NAMESPACE__.ITagUsage = __NAMESPACE__.TagUsageCodec.decode(input);
                ...
                case 2:
                    if (fieldType === thrift.TType.LIST) {
                        const value_6: Array<__NAMESPACE__.ITag> = new Array<__NAMESPACE__.ITag>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_7: __NAMESPACE__.ITag = __NAMESPACE__.TagCodec.decode(input);
                ...
                case 3:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_8: __NAMESPACE__.ITag = __NAMESPACE__.TagCodec.decode(input);
                ...
                case 4:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_9: __NAMESPACE__.INewspaper = __NAMESPACE__.NewspaperCodec.decode(input);
                ...
                case 5:
                    if (fieldType === thrift.TType.LIST) {
                        const value_10: Array<__NAMESPACE__.IReference> = new Array<__NAMESPACE__.IReference>();
                        const metadata_3: thrift.IThriftList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_11: __NAMESPACE__.IReference = __NAMESPACE__.ReferenceCodec.decode(input);
...
export class Taxonomy extends thrift.StructLike implements ITaxonomy {
    ...
    constructor(args: ITaxonomyArgs = {}) {
        super();
        if (args.tags != null) {
            const value_12: Array<__NAMESPACE__.ITagUsage> = new Array<__NAMESPACE__.ITagUsage>();
            args.tags.forEach((value_17: __NAMESPACE__.ITagUsageArgs): void => {
                const value_18: __NAMESPACE__.ITagUsage = new __NAMESPACE__.TagUsage(value_17);
        ...
        if (args.contributors != null) {
            ...
            args.contributors.forEach((value_19: __NAMESPACE__.ITagArgs): void => {
        ...
        if (args.publication != null) {
            const value_14: __NAMESPACE__.ITag = new __NAMESPACE__.Tag(args.publication);
            this.publication = value_14;
        }
        if (args.newspaper != null) {
            const value_15: __NAMESPACE__.INewspaper = new __NAMESPACE__.Newspaper(args.newspaper);
            this.newspaper = value_15;
        }
        if (args.references != null) {
            const value_16: Array<__NAMESPACE__.IReference> = new Array<__NAMESPACE__.IReference>();
            args.references.forEach((value_21: __NAMESPACE__.IReferenceArgs): void => {
                const value_22: __NAMESPACE__.IReference = new __NAMESPACE__.Reference(value_21);
