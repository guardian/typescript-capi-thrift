            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_3: __NAMESPACE__.IImageAssetDimensions = __NAMESPACE__.ImageAssetDimensionsCodec.decode(input);
...
export class ImageAsset extends thrift.StructLike implements IImageAsset {
    ...
    constructor(args: IImageAssetArgs) {
        ...
        if (args.dimensions != null) {
            const value_13: __NAMESPACE__.IImageAssetDimensions = new __NAMESPACE__.ImageAssetDimensions(args.dimensions);
