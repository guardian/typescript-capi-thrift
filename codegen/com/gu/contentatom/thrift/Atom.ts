...
export const AtomCodec: thrift.IStructCodec<IAtomArgs, IAtom> = {
    encode(args: IAtomArgs, output: thrift.TProtocol): void {
        ...
        if (obj.contentChangeDetails != null) {
            ...
            __NAMESPACE__.ContentChangeDetailsCodec.encode(obj.contentChangeDetails, output);
            output.writeFieldEnd();
        }
        else {
            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_8: __NAMESPACE__.IAtomData = __NAMESPACE__.AtomDataCodec.decode(input);
                        _args.data = value_8;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 6:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_9: __NAMESPACE__.IContentChangeDetails = __NAMESPACE__.ContentChangeDetailsCodec.decode(input);
                ...
                case 7:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_10: __NAMESPACE__.IFlags = __NAMESPACE__.FlagsCodec.decode(input);
...
export class Atom extends thrift.StructLike implements IAtom {
    ...
    constructor(args: IAtomArgs) {
        ...
        if (args.data != null) {
            const value_18: __NAMESPACE__.IAtomData = new __NAMESPACE__.AtomData(args.data);
            this.data = value_18;
        }
        else {
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Required field[data] is unset!");
        ...
        if (args.contentChangeDetails != null) {
            const value_19: __NAMESPACE__.IContentChangeDetails = new __NAMESPACE__.ContentChangeDetails(args.contentChangeDetails);
        ...
        if (args.flags != null) {
            const value_20: __NAMESPACE__.IFlags = new __NAMESPACE__.Flags(args.flags);
            this.flags = value_20;
        }
        if (args.title != null) {
