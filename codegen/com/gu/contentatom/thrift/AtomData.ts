...
export const AtomDataCodec: thrift.IStructCodec<IAtomDataArgs, IAtomData> = {
    encode(args: IAtomDataArgs, output: thrift.TProtocol): void {
        ...
        if (obj.interactive != null) {
            ...
            contentatom_interactive.InteractiveAtomCodec.encode(obj.interactive, output);
            output.writeFieldEnd();
        }
        if (obj.review != null) {
            _fieldsSet++;
        ...
        if (obj.storyquestions != null) {
            ...
            contentatom_storyquestions.StoryQuestionsAtomCodec.encode(obj.storyquestions, output);
            output.writeFieldEnd();
        }
        if (obj.qanda != null) {
            _fieldsSet++;
        ...
        if (obj.commonsDivision != null) {
            ...
            contentatom_commonsdivision.CommonsDivisionCodec.encode(obj.commonsDivision, output);
            output.writeFieldEnd();
        }
        if (obj.chart != null) {
            _fieldsSet++;
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_1: contentatom_quiz.IQuizAtom = contentatom_quiz.QuizAtomCodec.decode(input);
                ...
                case 3:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_2: contentatom_media.IMediaAtom = contentatom_media.MediaAtomCodec.decode(input);
                ...
                case 4:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_3: contentatom_explainer.IExplainerAtom = contentatom_explainer.ExplainerAtomCodec.decode(input);
                ...
                case 5:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_4: contentatom_cta.ICTAAtom = contentatom_cta.CTAAtomCodec.decode(input);
                ...
                case 6:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_5: contentatom_interactive.IInteractiveAtom = contentatom_interactive.InteractiveAtomCodec.decode(input);
                ...
                case 7:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_6: contentatom_review.IReviewAtom = contentatom_review.ReviewAtomCodec.decode(input);
                ...
                case 8:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_7: contentatom_recipe.IRecipeAtom = contentatom_recipe.RecipeAtomCodec.decode(input);
                ...
                case 9:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_8: contentatom_storyquestions.IStoryQuestionsAtom = contentatom_storyquestions.StoryQuestionsAtomCodec.decode(input);
                ...
                case 10:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_9: contentatom_qanda.IQAndAAtom = contentatom_qanda.QAndAAtomCodec.decode(input);
                ...
                case 11:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_10: contentatom_guide.IGuideAtom = contentatom_guide.GuideAtomCodec.decode(input);
                ...
                case 12:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_11: contentatom_profile.IProfileAtom = contentatom_profile.ProfileAtomCodec.decode(input);
                ...
                case 13:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_12: contentatom_timeline.ITimelineAtom = contentatom_timeline.TimelineAtomCodec.decode(input);
                ...
                case 14:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_13: contentatom_commonsdivision.ICommonsDivision = contentatom_commonsdivision.CommonsDivisionCodec.decode(input);
                ...
                case 15:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_14: contentatom_chart.IChartAtom = contentatom_chart.ChartAtomCodec.decode(input);
                ...
                case 16:
                    if (fieldType === thrift.TType.STRUCT) {
                        _fieldsSet++;
                        const value_15: contentatom_audio.IAudioAtom = contentatom_audio.AudioAtomCodec.decode(input);
...
export class AtomData extends thrift.StructLike implements IAtomData {
    ...
    constructor(args: IAtomDataArgs = {}) {
        ...
        if (args.quiz != null) {
            _fieldsSet++;
            const value_16: contentatom_quiz.IQuizAtom = new contentatom_quiz.QuizAtom(args.quiz);
            this.quiz = value_16;
        }
        if (args.media != null) {
            _fieldsSet++;
            const value_17: contentatom_media.IMediaAtom = new contentatom_media.MediaAtom(args.media);
            this.media = value_17;
        }
        if (args.explainer != null) {
            _fieldsSet++;
            const value_18: contentatom_explainer.IExplainerAtom = new contentatom_explainer.ExplainerAtom(args.explainer);
            this.explainer = value_18;
        }
        if (args.cta != null) {
            _fieldsSet++;
            const value_19: contentatom_cta.ICTAAtom = new contentatom_cta.CTAAtom(args.cta);
            this.cta = value_19;
        }
        if (args.interactive != null) {
            _fieldsSet++;
            const value_20: contentatom_interactive.IInteractiveAtom = new contentatom_interactive.InteractiveAtom(args.interactive);
            this.interactive = value_20;
        }
        if (args.review != null) {
            _fieldsSet++;
            const value_21: contentatom_review.IReviewAtom = new contentatom_review.ReviewAtom(args.review);
            this.review = value_21;
        }
        if (args.recipe != null) {
            _fieldsSet++;
            const value_22: contentatom_recipe.IRecipeAtom = new contentatom_recipe.RecipeAtom(args.recipe);
            this.recipe = value_22;
        }
        if (args.storyquestions != null) {
            _fieldsSet++;
            const value_23: contentatom_storyquestions.IStoryQuestionsAtom = new contentatom_storyquestions.StoryQuestionsAtom(args.storyquestions);
            this.storyquestions = value_23;
        }
        if (args.qanda != null) {
            _fieldsSet++;
            const value_24: contentatom_qanda.IQAndAAtom = new contentatom_qanda.QAndAAtom(args.qanda);
            this.qanda = value_24;
        }
        if (args.guide != null) {
            _fieldsSet++;
            const value_25: contentatom_guide.IGuideAtom = new contentatom_guide.GuideAtom(args.guide);
            this.guide = value_25;
        }
        if (args.profile != null) {
            _fieldsSet++;
            const value_26: contentatom_profile.IProfileAtom = new contentatom_profile.ProfileAtom(args.profile);
            this.profile = value_26;
        }
        if (args.timeline != null) {
            _fieldsSet++;
            const value_27: contentatom_timeline.ITimelineAtom = new contentatom_timeline.TimelineAtom(args.timeline);
            this.timeline = value_27;
        }
        if (args.commonsDivision != null) {
            _fieldsSet++;
            const value_28: contentatom_commonsdivision.ICommonsDivision = new contentatom_commonsdivision.CommonsDivision(args.commonsDivision);
            this.commonsDivision = value_28;
        }
        if (args.chart != null) {
            _fieldsSet++;
            const value_29: contentatom_chart.IChartAtom = new contentatom_chart.ChartAtom(args.chart);
            this.chart = value_29;
        }
        if (args.audio != null) {
            _fieldsSet++;
            const value_30: contentatom_audio.IAudioAtom = new contentatom_audio.AudioAtom(args.audio);
            this.audio = value_30;
        }
        if (_fieldsSet > 1) {
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.INVALID_DATA, "TUnion cannot have more than one value");
