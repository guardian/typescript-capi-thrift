...
export const StoryEventCodec: thrift.IStructCodec<IStoryEventArgs, IStoryEvent> = {
    encode(args: IStoryEventArgs, output: thrift.TProtocol): void {
        ...
        if (obj.content != null) {
            ...
            obj.content.forEach((value_1: __NAMESPACE__.IContentArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.TType.LIST) {
                        const value_5: Array<__NAMESPACE__.IContent> = new Array<__NAMESPACE__.IContent>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_6: __NAMESPACE__.IContent = __NAMESPACE__.ContentCodec.decode(input);
...
export class StoryEvent extends thrift.StructLike implements IStoryEvent {
    ...
    constructor(args: IStoryEventArgs) {
        ...
        if (args.content != null) {
            const value_10: Array<__NAMESPACE__.IContent> = new Array<__NAMESPACE__.IContent>();
            args.content.forEach((value_11: __NAMESPACE__.IContentArgs): void => {
                const value_12: __NAMESPACE__.IContent = new __NAMESPACE__.Content(value_11);
