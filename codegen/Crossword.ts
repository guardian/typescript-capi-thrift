...
export const CrosswordCodec: thrift.IStructCodec<ICrosswordArgs, ICrossword> = {
    encode(args: ICrosswordArgs, output: thrift.TProtocol): void {
        ...
        if (obj.entries != null) {
            ...
            obj.entries.forEach((value_1: __NAMESPACE__.ICrosswordEntryArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_5: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
                        _args.date = value_5;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 5:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_6: __NAMESPACE__.ICrosswordDimensions = __NAMESPACE__.CrosswordDimensionsCodec.decode(input);
                ...
                case 6:
                    if (fieldType === thrift.TType.LIST) {
                        const value_7: Array<__NAMESPACE__.ICrosswordEntry> = new Array<__NAMESPACE__.ICrosswordEntry>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_8: __NAMESPACE__.ICrosswordEntry = __NAMESPACE__.CrosswordEntryCodec.decode(input);
                ...
                case 11:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_13: __NAMESPACE__.ICrosswordCreator = __NAMESPACE__.CrosswordCreatorCodec.decode(input);
...
export class Crossword extends thrift.StructLike implements ICrossword {
    ...
    constructor(args: ICrosswordArgs) {
        ...
        if (args.date != null) {
            const value_20: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.date);
            this.date = value_20;
        }
        else {
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Required field[date] is unset!");
        ...
        if (args.dimensions != null) {
            const value_21: __NAMESPACE__.ICrosswordDimensions = new __NAMESPACE__.CrosswordDimensions(args.dimensions);
        ...
        if (args.entries != null) {
            const value_22: Array<__NAMESPACE__.ICrosswordEntry> = new Array<__NAMESPACE__.ICrosswordEntry>();
            args.entries.forEach((value_31: __NAMESPACE__.ICrosswordEntryArgs): void => {
                const value_32: __NAMESPACE__.ICrosswordEntry = new __NAMESPACE__.CrosswordEntry(value_31);
        ...
        if (args.creator != null) {
            const value_27: __NAMESPACE__.ICrosswordCreator = new __NAMESPACE__.CrosswordCreator(args.creator);
        ...
        if (args.dateSolutionAvailable != null) {
            const value_30: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.dateSolutionAvailable);
