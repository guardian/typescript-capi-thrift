            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_8: __NAMESPACE__.ICrosswordPosition = __NAMESPACE__.CrosswordPositionCodec.decode(input);
...
export class CrosswordEntry extends thrift.StructLike implements ICrosswordEntry {
    ...
    constructor(args: ICrosswordEntryArgs) {
        ...
        if (args.position != null) {
            const value_22: __NAMESPACE__.ICrosswordPosition = new __NAMESPACE__.CrosswordPosition(args.position);
