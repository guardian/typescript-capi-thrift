            ...
            switch (fieldId) {
                ...
                case 55:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_55: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
                ...
                case 66:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_66: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
                ...
                case 67:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_67: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
                        _args.end = value_67;
                    }
                    else {
                        input.skip(fieldType);
...
export class AssetFields extends thrift.StructLike implements IAssetFields {
    ...
    constructor(args: IAssetFieldsArgs = {}) {
        ...
        if (args.dateCreated != null) {
            const value_123: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.dateCreated);
        ...
        if (args.start != null) {
            const value_134: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.start);
            this.start = value_134;
        }
        if (args.end != null) {
            const value_135: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.end);
            this.end = value_135;
        }
