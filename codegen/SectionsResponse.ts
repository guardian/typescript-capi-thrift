...
export const SectionsResponseCodec: thrift.IStructCodec<ISectionsResponseArgs, ISectionsResponse> = {
    encode(args: ISectionsResponseArgs, output: thrift.TProtocol): void {
        ...
        if (obj.results != null) {
            ...
            obj.results.forEach((value_1: __NAMESPACE__.ISectionArgs): void => {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.TType.LIST) {
                        const value_5: Array<__NAMESPACE__.ISection> = new Array<__NAMESPACE__.ISection>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_6: __NAMESPACE__.ISection = __NAMESPACE__.SectionCodec.decode(input);
...
export class SectionsResponse extends thrift.StructLike implements ISectionsResponse {
    ...
    constructor(args: ISectionsResponseArgs) {
        ...
        if (args.results != null) {
            const value_10: Array<__NAMESPACE__.ISection> = new Array<__NAMESPACE__.ISection>();
            args.results.forEach((value_11: __NAMESPACE__.ISectionArgs): void => {
                const value_12: __NAMESPACE__.ISection = new __NAMESPACE__.Section(value_11);
