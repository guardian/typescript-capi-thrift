            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_4: __NAMESPACE__.IAssetFields = __NAMESPACE__.AssetFieldsCodec.decode(input);
...
export class Asset extends thrift.StructLike implements IAsset {
    ...
    constructor(args: IAssetArgs) {
        ...
        if (args.typeData != null) {
            const value_8: __NAMESPACE__.IAssetFields = new __NAMESPACE__.AssetFields(args.typeData);
