...
export interface IContentFields {
    ...
    membershipAccess?: __NAMESPACE__.MembershipTier;
    wordcount?: number;
    commentCloseDate?: __NAMESPACE__.ICapiDateTime;
    commentable?: boolean;
    creationDate?: __NAMESPACE__.ICapiDateTime;
    displayHint?: string;
    firstPublicationDate?: __NAMESPACE__.ICapiDateTime;
    ...
    newspaperEditionDate?: __NAMESPACE__.ICapiDateTime;
    productionOffice?: __NAMESPACE__.Office;
    publication?: string;
    scheduledPublicationDate?: __NAMESPACE__.ICapiDateTime;
...
export interface IContentFieldsArgs {
    ...
    membershipAccess?: __NAMESPACE__.MembershipTier;
    wordcount?: number;
    commentCloseDate?: __NAMESPACE__.ICapiDateTimeArgs;
    commentable?: boolean;
    creationDate?: __NAMESPACE__.ICapiDateTimeArgs;
    displayHint?: string;
    firstPublicationDate?: __NAMESPACE__.ICapiDateTimeArgs;
    hasStoryPackage?: boolean;
    internalComposerCode?: string;
    internalOctopusCode?: string;
    internalPageCode?: number;
    ...
    liveBloggingNow?: boolean;
    newspaperEditionDate?: __NAMESPACE__.ICapiDateTimeArgs;
    productionOffice?: __NAMESPACE__.Office;
    publication?: string;
    scheduledPublicationDate?: __NAMESPACE__.ICapiDateTimeArgs;
    secureThumbnail?: string;
    shortUrl?: string;
    shouldHideAdverts?: boolean;
    showInRelatedContent?: boolean;
...
export const ContentFieldsCodec: thrift.IStructCodec<IContentFieldsArgs, IContentFields> = {
    encode(args: IContentFieldsArgs, output: thrift.TProtocol): void {
        ...
        if (obj.commentCloseDate != null) {
            ...
            __NAMESPACE__.CapiDateTimeCodec.encode(obj.commentCloseDate, output);
            output.writeFieldEnd();
        }
        ...
        if (obj.creationDate != null) {
            ...
            __NAMESPACE__.CapiDateTimeCodec.encode(obj.creationDate, output);
            output.writeFieldEnd();
        }
        ...
        if (obj.firstPublicationDate != null) {
            ...
            __NAMESPACE__.CapiDateTimeCodec.encode(obj.firstPublicationDate, output);
            output.writeFieldEnd();
        }
        ...
        if (obj.newspaperEditionDate != null) {
            ...
            __NAMESPACE__.CapiDateTimeCodec.encode(obj.newspaperEditionDate, output);
            output.writeFieldEnd();
        }
        ...
        if (obj.scheduledPublicationDate != null) {
            ...
            __NAMESPACE__.CapiDateTimeCodec.encode(obj.scheduledPublicationDate, output);
            output.writeFieldEnd();
        }
    ...
    decode(input: thrift.TProtocol): IContentFields {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 10:
                    if (fieldType === thrift.TType.I32) {
                        const value_10: __NAMESPACE__.MembershipTier = input.readI32();
                ...
                case 12:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_12: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
                ...
                case 14:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_14: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
                ...
                case 16:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_16: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
                ...
                case 24:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_24: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
                ...
                case 26:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_26: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
                ...
                case 27:
                    if (fieldType === thrift.TType.I32) {
                        const value_27: __NAMESPACE__.Office = input.readI32();
                ...
                case 29:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_29: __NAMESPACE__.ICapiDateTime = __NAMESPACE__.CapiDateTimeCodec.decode(input);
...
export class ContentFields extends thrift.StructLike implements IContentFields {
    ...
    public membershipAccess?: __NAMESPACE__.MembershipTier;
    public wordcount?: number;
    public commentCloseDate?: __NAMESPACE__.ICapiDateTime;
    public commentable?: boolean;
    public creationDate?: __NAMESPACE__.ICapiDateTime;
    public displayHint?: string;
    public firstPublicationDate?: __NAMESPACE__.ICapiDateTime;
    ...
    public newspaperEditionDate?: __NAMESPACE__.ICapiDateTime;
    public productionOffice?: __NAMESPACE__.Office;
    public publication?: string;
    public scheduledPublicationDate?: __NAMESPACE__.ICapiDateTime;
    ...
    constructor(args: IContentFieldsArgs = {}) {
        ...
        if (args.membershipAccess != null) {
            const value_61: __NAMESPACE__.MembershipTier = args.membershipAccess;
        ...
        if (args.commentCloseDate != null) {
            const value_63: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.commentCloseDate);
        ...
        if (args.creationDate != null) {
            const value_65: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.creationDate);
        ...
        if (args.firstPublicationDate != null) {
            const value_67: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.firstPublicationDate);
        ...
        if (args.lastModified != null) {
            const value_75: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.lastModified);
        ...
        if (args.newspaperEditionDate != null) {
            const value_77: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.newspaperEditionDate);
            this.newspaperEditionDate = value_77;
        }
        if (args.productionOffice != null) {
            const value_78: __NAMESPACE__.Office = args.productionOffice;
        ...
        if (args.scheduledPublicationDate != null) {
            const value_80: __NAMESPACE__.ICapiDateTime = new __NAMESPACE__.CapiDateTime(args.scheduledPublicationDate);
